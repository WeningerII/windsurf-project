...
7. [Phase 7: Architecture V2](#phase-7-architecture-v2-week-13)
...
npm test           # Full test suite should pass
...
**Current:** 134 spells (Core Rulebook), 86 CRB feats (combat 47, metamagic 9, general 30), 70 equipment  
**Status:** Core Rulebook content verified ✅  
**Cleanup (Feb 10, 2026):** Removed 650 fabricated Array.from placeholders + 10 non-CRB teamwork feats.  
**QA (Feb 10, 2026):** Verified against d20pfsrd.com. Removed 7 more fabricated/non-CRB feats: sneakAttack (class feature), shieldBash (not a feat), nimbleFingers (404), diligent (404), focusedMind (racial trait), acrobaticsTraining (fake APG), twinnedSpell (D&D 5e feat). Removed 10 APG metamagic feats to keep PF1 feats fully Core Rulebook-only.

**Success Criteria:**
- ✅ 134 PF1e spells implemented (Core Rulebook)
- ✅ 86 CRB feats verified against d20pfsrd.com
- ✅ All pass validation, 0 duplicates, 0 non-compliant
- ✅ Tests updated, metadata updated

**Assignee:** Content Developer + Junior Dev  
**Estimated Time:** 1 week (QA pass)  
**Dependencies:** None

---

### 5.2 Pathfinder 2e Expansion
**Current:** 146 spells (Core Rulebook), 93 feats (general 16, skill 27, ancestry 27, class 23), 188 equipment, 5 archetypes  
**Status:** Core Rulebook content verified ✅  
**Cleanup (Feb 10, 2026):** Removed 135 fabricated Array.from placeholders + 5 orphan dead-code files.  
**QA (Feb 10, 2026):** Verified against PF2e CRB. Removed 4 non-CRB general feats: feather-step (not CRB general), general-training (duplicate of ancestry.ts), multitalented (Half-Elf ancestry feat), improvised-repair (not a CRB feat). General feats now match CRB's 16 exactly.

**Success Criteria:**
- ✅ 146 PF2e spells (Core Rulebook)
- ✅ 93 CRB feats verified against PF2e CRB
- ✅ 5 CRB archetypes
- ✅ All pass validation, 0 duplicates, 0 non-compliant
- ✅ Metadata updated
...
**Current:** 61 SRD-verified powers, 74 advantages (SRD-complete), 28 complications (SRD-complete), 29 conditions (SRD-complete: 16 basic + 13 combined), 15 archetypes, 150 equipment  
**Status:** Core content complete ✅ — all verified against d20herosrd.com SRD  
**QA (Feb 10, 2026):** Removed 2 non-SRD complications (statusQuo, unluck). Added 3 missing SRD conditions (Blind, Deaf, Surprised). Fixed powerLoss description, vulnerable description, prone effects.

**Completed (Feb 10, 2026):**
- ✅ 61 SRD-verified powers (40 core effects + 21 sample powers)
- ✅ 74 SRD-verified advantages (combat 33, skill 19, general 16, fortune 6) — deduplicated and category-corrected
- ✅ 28 complications (8 motivations + 20 complication types) — QA-verified against d20herosrd.com
- ✅ 29 conditions (16 basic + 13 combined) — QA-verified against d20herosrd.com
- ✅ 15 archetypes, 150 equipment, 16 skills
- ✅ 0 duplicates across all module audit rows

**Success Criteria:**
- ✅ All criteria met — QA complete

**Assignee:** Content Developer (M&M specialist)  
**Estimated Time:** QA only (~2 hours)  
**Dependencies:** None

---

### 5.4 D&D 3.5e Equipment Completion
**Current:** 207 equipment items, 0 duplicates, 0 non-compliant (SRD 3.5)  
**Status:** Core SRD equipment implemented ✅

**Success Criteria:**
- ✅ 207 SRD equipment items
- ✅ All validated, 0 compliance issues
...
## Phase 7: Architecture V2 (Week 13)
**Priority:** � CRITICAL
**Estimated Effort:** 1 week
**Status:** ✅ Complete

### 7.1 Document & Data Model
**Goal:** Decouple system logic from UI and establish a strict data pattern.

**Implementation:**
- **CharacterDocument<T>:** Generic container for all system data.
- **SystemRegistry:** Singleton for managing system definitions.
- **SystemEngine<T>:** Interface for system-specific logic (prepareData, rollCheck).
- **Persistence:** `useDocuments` hook with auto-migration from legacy format.

**Success Criteria:**
- ✅ All 6 systems registered in SystemRegistry.
- ✅ Legacy data auto-migrates to V2 format.
- ✅ Type safety enforced across all systems.

### 7.2 Native Character Sheets
**Goal:** Provide system-specific UI experiences.

**Implementation:**
- **D20SheetAdapter:** Bridge for D&D 5e 2014/2024 (legacy compatibility).
- **D20LegacySheet:** Native sheet for D&D 3.5e and PF1e (BAB, 3 saves, etc.).
- **Pf2eCharacterSheet:** Native sheet for PF2e (proficiency badges, hero points).
- **Mam3eCharacterSheet:** Native sheet for M&M 3e (point buy, power points).

**Success Criteria:**
- ✅ Native sheets implemented for all non-5e systems.
- ✅ D&D 5e systems seamlessly adapted.
- ✅ All sheets support full editing and persistence.

### 7.3 System Engines
**Goal:** Implement real game mechanics for all systems.

**Implementation:**
- **D&D 5e (2014/2024):** AC, HP, skills, saves, proficiency.
- **D&D 3.5e / PF1e:** BAB, CMB/CMD, size modifiers, skill ranks.
- **PF2e:** 4-tier proficiency, conditions, bulk.
- **M&M 3e:** Point buy validation, power costs, defenses.

**Success Criteria:**
- ✅ 6/6 engines implemented.
...
- [x] PF1e: 134 spells (Core Rulebook), 86 CRB feats (650 fabricated placeholders removed Feb 10)
- [x] PF2e: 146 spells (Core Rulebook), 93 CRB feats (135 fabricated placeholders removed Feb 10)
- [x] M&M 3e: 61 SRD-verified powers, 74 SRD advantages, 28 complications, 15 archetypes
- [x] D&D 5e-2014: 238 spells implemented (SRD 5.1)
- [x] D&D 3.5e: 207 SRD equipment items, 515 feats
- [x] 0 fabricated/placeholder data remaining across all systems
- [x] 0 duplicates, 0 non-compliant across all loader and module audits
...
- [x] Architecture V2 refactor complete
- [x] 6/6 system engines implemented with tests
- [x] Native sheets for PF2e, M&M 3e, D&D 3.5e/PF1e
- [x] Auto-migration from legacy format verified
...
| Architecture refactor introduces regressions | High | Medium | Comprehensive unit tests, staged rollout |
...
- Phase 7 depends on Phase 5 content stability
...
### Required Roles
- **Senior TypeScript Developer** (Phase 1, 3, 7)
- **Frontend Developers** (2x, Phase 3, 7)
...
Week 13: ████ Phase 7 (Architecture V2)
...
## Current Content Status (February 2026)
...
| D&D 5e (2014) | ~95% | ✅ Near Complete | 0 feats in loader |
| D&D 3.5e | 98% | ✅ Near Complete | 0 monsters |
| Pathfinder 1e | ✅ Core | ✅ Complete | QA pass on 86 feats |
| Pathfinder 2e | ✅ Core | ✅ Complete | QA pass on 93 feats |
| M&M 3e | ✅ Core | ✅ Complete | QA pass on complications/conditions |

### Completed Work (Feb 10, 2026) — Data Quality Cleanup

**Fabricated Placeholder Removal** ✅
- Removed 650 PF1e fabricated feats (5 Array.from placeholder files: racial, class, magic, ability, divine)
- Removed 135 PF2e fabricated feats (magic-feats.ts Array.from placeholder)
- Removed 10 PF1e non-CRB teamwork feats (source: Advanced Player's Guide)
- Deleted 5 PF2e orphan dead-code files (general-feats.ts, combat-feats.ts, skill-feats.ts, ancestry-feats.ts, class-feats.ts)
- Updated dataLoader, metadata files, and feats indexes
- Real feat counts: PF1e 86 (was inflated to 742), PF2e 93 (was inflated to 231)

**M&M 3e SRD Compliance** ✅
- Deduplicated and category-corrected 74 SRD advantages
- Verified 61 SRD powers (40 core + 21 sample)
- Confirmed 28 SRD complications after removing 2 non-SRD entries (previously unreported as "0")
- Fixed structural duplication in metrics (powers, advantages, archetypes modules)
- Improved metrics script to use canonical arrays directly

**Metrics Infrastructure** ✅
- 0 duplicates across all loader and module audit rows
