...
| D&D 3.5e | Partial | Shared legacy sheet, full core prestige catalog is selectable, canonical 554-spell loader-backed catalog with alias-safe class-stub duplicate collapse, source-backed legacy spell metadata, Vancian tracked/prepared workflow, manual extras, no monster product surface |
