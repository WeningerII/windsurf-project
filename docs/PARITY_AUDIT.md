...
1. **Registry validators** — was 5e-only.
   - ✅ **M&M 3e** (`src/systems/mam3e/validation.ts`, 2026-06-23): surfaces the
     engine's PL trade-off caps + power-point budget.
   - ✅ **Daggerheart** (`src/systems/daggerheart/validation.ts`, 2026-06-23):
     class/ancestry resolution, SRD creation trait array, Hope bounds.
   - ❌ **PF2e, D&D 3.5e, Pathfinder 1e** — still no validator.
