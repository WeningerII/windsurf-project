...
export const level4Spells: Spell[] = [
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'You place a curse on the subject. Choose one of the following three effects: -6 decrease to an ability score (minimum 1), -4 penalty on attack rolls, saves, ability checks, and skill checks, or each turn the target has a 50% chance to act normally; otherwise, it does nothing.',
    savingThrow: {
      attribute: 'wis',
      success: 'none'
    },
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: 'This spell conjures a field of rubbery black tentacles, each 10 feet long. These waving members seem to spring forth from the earth, floor, or whatever surface is underfoot. The tentacles grapple and constrict opponents who enter the area, dealing 1d6+4 points of damage per round.',
    damage: {
      base: {
        count: 1,
        die: 'd6',
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'This spell causes confusion in the targets, making them unable to independently determine what they will do. Roll on the following table each round to see what the subject does. A confused character who can\'t carry out the indicated action does nothing but babble incoherently.',
    savingThrow: {
      attribute: 'wis',
      success: 'none'
    },
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'You touch a creature and grant it a measure of protection from death. The first time the target would drop to 0 hit points as a result of taking damage, the target instead drops to 1 hit point.',
    classes: [
      'cleric',
      'sorcerer',
      'wizard'
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'You point your finger and utter the incantation, releasing a black ray of crackling negative energy that suppresses the life force of any living creature it strikes. You must make a ranged touch attack to hit. If the attack succeeds, the subject gains 1d4 temporary negative levels.',
    classes: [
      'sorcerer',
      'wizard'
    ],
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'This spell functions like enlarge person, except that it affects multiple creatures. This spell causes instant growth of a humanoid creature, doubling its height and multiplying its weight by 8. This increase changes the creature\'s size category to the next larger one.',
    classes: [
      'sorcerer',
      'wizard'
    ],
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'Fire trap creates a fiery explosion when an intruder opens the item that the trap protects. A fire trap can ward any object that can be opened and closed. When the trap is triggered, a fiery explosion erupts dealing 1d4+1 per caster level (max +20) fire damage.',
    damage: {
      base: {
        count: 1,
        die: 'd4',
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'Great magical hailstones pound down for 1 full round, dealing 3d6 points of bludgeoning damage and 2d6 points of cold damage to every creature in the area. A -4 penalty applies to each Listen check made within the ice storm\'s effect, and all land movement within its area is at half speed.',
    damage: {
      base: {
        count: 3,
        die: 'd6',
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'This spell functions like invisibility, except that it doesn\'t end if the subject attacks. The spell ends if the subject makes an attack that directly affects the enemy (not just an area effect).',
    classes: [
      'bard',
      'sorcerer',
      'wizard'
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'This spell functions like locate object, except this spell locates a known or familiar creature. You slowly turn and sense when you are facing the direction of the creature, as long as the creature is within range. You can sense the general direction of the creature\'s location, as long as it is within range.',
    classes: [
      'bard',
      'sorcerer',
      'wizard'
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'You create a phantasmal image of the most fearsome creature imaginable to the subject simply by forming the fears of the subject\'s subconscious mind into something that its conscious mind can visualize. Only the spell\'s subject can see the phantasmal killer. If the subject of a phantasmal killer attack succeeds in disbelieving and possesses more than twice your caster level in Hit Dice, the phantasmal killer can turn on you and attack you.',
    savingThrow: {
      attribute: 'wis',
      success: 'none'
    },
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialDescription: 'Hemispherical piece of clear crystal, a matching hemispherical piece of gum arabic'
    },
    duration: {
      type: 'minutes',
      minutes: 1
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialDescription: 'Focus worth 1,000 gp such as crystal ball, silver mirror, or font of holy water'
    },
    duration: {
      type: 'minutes',
      minutes: 1
    ...
    concentration: false,
    ritual: false,
    description: 'You can see and hear some creature, which may be at any distance. If the subject succeeds on a Will save, the scrying attempt simply fails. The difficulty of the save depends on how well you know the subject and what sort of physical connection (if any) you have to that creature.',
    savingThrow: {
      attribute: 'wis',
      success: 'none'
    },
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'You conjure a sturdy cottage or lodge made of material that is common in the area where the spell is cast. The floor is level, clean, and dry. The lodging has a sturdy door, two or more shuttered windows, and a small fireplace.',
    classes: [
      'bard',
      'sorcerer',
      'wizard'
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'The warded creature is immune to the effects of one specified spell for every four levels you have. The spells must be of 4th level or lower. The warded creature effectively has unbeatable spell resistance regarding the specified spell(s).',
    classes: [
      'cleric',
      'paladin'
    ],
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'You can form an existing piece of stone into any shape that suits your purpose. While it\'s possible to make crude coffers, doors, and so forth, fine detail isn\'t possible. There is a 30% chance that any shape including moving parts simply doesn\'t work.',
    classes: [
      'cleric',
      'druid',
      'sorcerer',
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'The warded creature gains damage reduction 10/adamantine. The subject gains resistance to blows, cuts, stabs, and slashes. The spell reduces physical damage by 10 points. Once the spell has prevented a total of 10 points of damage per caster level (maximum 150 points), it is discharged.',
    classes: [
      'druid',
      'sorcerer',
      'wizard'
