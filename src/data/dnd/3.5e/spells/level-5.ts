...
export const level5Spells: Spell[] = [
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: 'You mentally contact a demigod, the spirit of a long-dead sage, or some other mysterious entity from another plane. Serving as your intermediary, the entity answers five yes-or-no questions that you pose to it.',
    classes: [
      'wizard'
    ],
    levelsByClass: {
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'As you cast this spell, you make a melee spell attack against a creature you can reach. On a hit, you attempt to send the creature to another plane of existence. The creature must make a Charisma saving throw.',
    savingThrow: {
      attribute: 'cha',
      success: 'none'
    },
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'The creature you touch gains a benefit depending on its Wisdom modifier. The creature gains spell resistance equal to 12 + its Wisdom modifier.',
    classes: [
      'cleric',
      'druid',
      'ranger',
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: 'You gain the ability to move or manipulate creatures or objects by thought. When you cast the spell, and as your action each turn until the spell ends, you can exert your will on one creature or object you can see within range.',
    classes: [
      'sorcerer',
      'wizard'
    ],
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'You create a magical circle on the ground. Any creature that steps into the circle is instantly transported to another teleportation circle you designate.',
    classes: [
      'bard',
      'sorcerer',
      'wizard'
  ...
  },
  {
    ...
    components: {
      ...
      somatic: true,
      material: true,
      materialDescription: 'An ointment for the eyes that costs 25 gp; is made from mushroom powder, saffron, and fat; and is consumed by the spell'
    },
    duration: {
      type: 'hours',
      hours: 1
    ...
    concentration: false,
    ritual: false,
    description: 'For the spell\'s duration, the creature you touch sees things as they actually are. It sees through illusions, sees creatures and objects that are invisible, and sees the true form of shapeshifters.',
    classes: [
      'cleric',
      'sorcerer',
      'wizard'
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: 'Deals 2d4 fire damage out to 10 ft. and 1d4 out to 20 ft. Passing through wall deals 2d6 damage +1/level.',
    classes: [
      'druid'
    ],
    levelsByClass: {
  ...
  },
  {
    ...
    concentration: false,
    ritual: false,
    description: 'A wave of negative energy springs from your hand. Each creature in a 30-foot cone originating from you must make a Constitution saving throw. A creature takes 4d12 necrotic damage on a failed save, or half as much on a successful one.',
    damage: {
      base: {
        count: 4,
        die: 'd12',
