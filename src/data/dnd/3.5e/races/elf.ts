...
export const elf: Species = {
  ...
  traits: [
    ...
    },
    {
      ...
      source: 'Elf',
      description: 'Elves receive the Martial Weapon Proficiency feats for the longsword, rapier, longbow, and shortbow as bonus feats.',
    },
    {
      id: 'keen-senses-35e',
      name: 'Keen Senses',
      source: 'Elf',
      description: 'Elves have a +2 racial bonus on Listen, Search, and Spot checks. An elf who merely passes within 5 feet of a secret or concealed door is entitled to a Search check to notice it as if she were actively looking for it.',
    },
    {
  ...
  ageInfo: 'Elves are considered young until age 110, middle-aged at 175, old at 263, and venerable at 350.',
  
  alignmentTendency: 'Elves are usually chaotic good.',
  
  sizeDescription: 'Elves are slightly shorter than humans, standing 4½ to 5½ feet tall. Your size is Medium.',
};
