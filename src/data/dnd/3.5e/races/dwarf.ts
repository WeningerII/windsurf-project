...
export const dwarf: Species = {
  ...
  traits: [
    ...
    },
    {
      ...
      name: 'Stability',
      source: 'Dwarf',
      description: 'A dwarf gains a +4 bonus on ability checks made to resist being bull rushed or tripped when standing on the ground.',
    },
    {
      id: 'bonus-vs-giants',
      name: 'Bonus Against Giants',
      source: 'Dwarf',
      description: 'Dwarves gain a +1 bonus on attack rolls against orcs and goblinoids. Dwarves gain a +4 dodge bonus to Armor Class against monsters of the giant type.',
    },
  ],
  
  description: 'Dwarves are known for their skill in warfare, their ability to withstand physical and magical punishment, and their knowledge of the earth\'s secrets.',
  
  ageInfo: 'Dwarves are considered young until age 40, middle-aged at 125, old at 188, and venerable at 250.',
