// D&D 3.5e Metamagic Feats — SRD 3.5 only.
//
// 61 fabricated filler entries ("Beef Metamagic", "Bell Metamagic", ...) were
// purged; only the nine SRD 3.5 metamagic feats remain, re-cited as 'SRD 3.5'.
