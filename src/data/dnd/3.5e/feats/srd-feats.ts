...
export const srd35eGeneralFeats: FeatDefinition[] = [
  {
  ...
  },
  {
    ...
    benefits: ['Normal: See the normal disarm rules.'],
    special:
  ...
  },
  {
    ...
    benefits: ['You must have at least one hand free (holding nothing) to use this feat.'],
...
export const srd35eMetamagicFeats: FeatDefinition[] = [];

export const srd35eItemCreationFeats: FeatDefinition[] = [];
