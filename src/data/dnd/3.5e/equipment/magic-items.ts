...
export const ringOfSpellStoring: Item = {
  ...
  description:
    'This ring stores spells cast into it, holding them until the wearer uses them. The ring can store up to 5 levels worth of spells at a time.',
  requiresAttunement: false,
};
...
export const staffOfFire: Item = {
  ...
  description:
    'This staff allows use of the following spells: Burning hands (1 charge), Fireball (1 charge), Wall of fire (2 charges). The staff holds 50 charges when fully charged.',
  requiresAttunement: false,
};
...
export const staffOfFrost: Item = {
  ...
  description:
    'This staff allows use of the following spells: Ice storm (1 charge), Wall of ice (1 charge), Cone of cold (2 charges). The staff holds 50 charges when fully charged.',
  requiresAttunement: false,
};
...
export const staffOfHealing: Item = {
  ...
  description:
    'This staff allows use of the following spells: Cure light wounds (1 charge), Cure moderate wounds (1 charge), Cure serious wounds (2 charges), Cure critical wounds (3 charges). The staff holds 50 charges when fully charged.',
  requiresAttunement: false,
};
...
export const staffOfTheWoodlands: Item = {
  ...
  description:
    "This staff allows use of the following spells: Charm animal (1 charge), Speak with animals (1 charge), Barkskin (2 charges), Summon nature's ally VI (3 charges), Wall of thorns (3 charges), Animate plants (4 charges). The staff holds 50 charges when fully charged.",
  requiresAttunement: false,
};
