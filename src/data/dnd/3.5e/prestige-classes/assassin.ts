...
export const assassin: CharacterClass = {
  ...
  system: 'dnd-3.5e',
  source: 'DMG',
  description: 'An assassin is a highly trained killer who specializes in eliminating targets with precision and stealth.',
  hitDie: 'd6',
  ...
  toolProficiencies: [],
  skillProficiencies: { count: 4, options: ['Balance', 'Climb', 'Decipher Script', 'Disable Device', 'Disguise', 'Escape Artist', 'Forgery', 'Gather Information', 'Hide', 'Jump', 'Listen', 'Move Silently', 'Open Lock', 'Search', 'Sense Motive', 'Sleight of Hand', 'Spot', 'Tumble', 'Use Magic Device', 'Use Rope'], label: 'Choose 4 class skills' },
  equipmentChoices: [],
  features: [
