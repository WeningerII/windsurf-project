  ...
  features: [
    {
      ...
      features: [
        ...
        },
        {
          ...
          source: 'Rogue 1',
          description:
            'Rogues can use the Search skill to locate traps when the task has a Difficulty Class higher than 20. Finding a nonmagical trap has a DC of at least 20, or higher if it is well hidden.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Rogue 4',
          description:
            'Starting at 4th level, a rogue can react to danger before her senses would normally allow her to do so. She retains her Dexterity bonus to AC even if she is caught flat-footed or struck by an invisible attacker.',
        },
      ],
    },
    {
      ...
      features: [
        {
          id: 'rogue-5',
          name: 'Improved Trap Sense',
          source: 'Rogue 5',
          description: 'Trap sense bonus increases.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Rogue 6',
          description: 'Rogue gains a special ability.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Rogue 7',
          description: 'Evasion ability improves.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      features: [
        {
          id: 'rogue-9',
          name: 'Advanced Trap Sense',
          source: 'Rogue 9',
          description: 'Trap sense becomes more advanced.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Rogue 10',
          description:
            'On attaining 10th level, and at every three levels thereafter, a rogue gains a special ability of her choice from among the following options.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          name: 'Master Evasion',
          source: 'Rogue 11',
          description: 'Evasion reaches mastery.',
        },
      ],
    },
    {
      ...
      features: [
        {
          id: 'rogue-12',
          name: 'Advanced Uncanny Dodge',
          source: 'Rogue 12',
          description: 'Uncanny dodge becomes more advanced.',
        },
      ],
    },
    {
      ...
      features: [
        {
          id: 'rogue-13',
          name: 'Perfect Trap Sense',
          source: 'Rogue 13',
          description: 'Trap sense becomes perfect.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          name: 'Special Ability',
          source: 'Rogue 14',
          description: 'Rogue gains another special ability.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Rogue 15',
          description: 'Evasion reaches supreme power.',
        },
      ],
    },
    {
      ...
      features: [
        {
          id: 'rogue-16',
          name: 'Perfect Uncanny Dodge',
          source: 'Rogue 16',
          description: 'Uncanny dodge becomes perfect.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Rogue 17',
          description: 'Rogue becomes a master assassin.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          name: 'Perfect Rogue',
          source: 'Rogue 19',
          description: 'Rogue achieves perfect mastery.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          name: 'Shadow Master',
          source: 'Rogue 20',
          description: 'Rogue becomes a master of shadows.',
        },
      ],
    },
  ],
