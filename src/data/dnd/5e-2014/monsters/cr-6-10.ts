...
export const mage: Monster = {
  ...
  armorClass: 12,
  hitPoints: { count: 9, die: 'd8', modifier: 0, notation: '9d8' },
  speed: { walk: 30 },
...
export const aboleth: Monster = {
  ...
  experiencePoints: 5900,
  armorClass: 17,
  hitPoints: { count: 18, die: 'd10', modifier: 36, notation: '18d10+36' },
...
export const medusa: Monster = {
  ...
  experiencePoints: 2300,
  armorClass: 15,
  hitPoints: { count: 17, die: 'd8', modifier: 51, notation: '17d8+51' },
  speed: { walk: 30 },
