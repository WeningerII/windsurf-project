...
export const maneuvers: Feature[] = [
  {
    ...
    description: 'When a creature misses you with a melee attack, you can use your reaction and expend one superiority die to move up to your speed as a reaction right after the attack, and you can make one melee weapon attack against the attacker. If you hit, you add the superiority die to the damage of the attack.',
  },
  {
    id: 'maneuver-parry',
    name: 'Parry',
    source: 'Battle Master',
    description: 'If another creature damages you with a melee attack, you can use your reaction and expend one superiority die to reduce the damage by the number you roll on that die + your Dexterity modifier.',
  },
  {
    id: 'maneuver-disengage',
    name: 'Disarming Attack',
    source: 'Battle Master',
    description: 'When you hit a creature with a weapon attack, you can expend one superiority die to attempt to disarm your opponent. You add the superiority die to the attack\'s damage roll, and the target must make a Strength saving throw. On a failed save, it drops the weapon of your choice that it\'s holding.',
  },
  {
    id: 'maneuver-feint',
  ...
  },
  {
    ...
    name: 'Dodge',
    source: 'Battle Master',
    description: 'When an attacker that you can see hits you with an attack, you can use your reaction and expend one superiority die to reduce the damage by the number you roll on that die + your Dexterity modifier.',
  },
  {
    id: 'maneuver-push',
    name: 'Pushing Attack',
  ...
  },
  {
    ...
    description: 'When you make a Dexterity (Stealth) check or an initiative roll, you can expend one superiority die and add the number rolled to the total. You can use this maneuver before or after you roll, but before any effects of the roll are applied.',
  },
  {
    id: 'maneuver-brace',
    name: 'Brace',
    source: 'Battle Master (XGtE)',
    description: 'When a creature you can see moves into the reach you have with a melee weapon, you can use your reaction and expend one superiority die to increase your AC by the number rolled, as long as you aren\'t incapacitated.',
  },
  {
    id: 'maneuver-grappling-strike',
    name: 'Grappling Strike',
    source: 'Battle Master (XGtE)',
    description: 'Immediately after you hit a creature with a melee weapon attack, you can expend one superiority die to attempt to grapple the target. You add the superiority die to the grapple check.',
  },
  {
  ...
  },
  {
    ...
    source: 'Battle Master (XGtE)',
    description: 'When you make an Intelligence (Insight), an Intelligence (Investigation), or a Wisdom (Insight) check, you can expend one superiority die and add the number rolled to the total. You can use this maneuver before or after you roll, but before any effects of the roll are applied.',
  },
  {
  ...
  },
  {
    ...
    source: 'Battle Master',
    description: 'When you hit a creature with a melee weapon attack, you can expend one superiority die to attempt to damage another creature with the same attack. Choose another creature within 5 feet of the original target and within your reach. If the original attack roll would hit it, the other creature takes damage equal to the number you roll on your superiority die.',
  },
  {
    id: 'maneuver-control-beast',
    name: 'Control Beast',
    source: 'Battle Master',
    description: 'When you hit a beast with a weapon attack, you can expend one superiority die to attempt to control the beast on its next turn. You add the superiority die to the attack\'s damage roll. The beast must succeed on a Wisdom saving throw or have disadvantage on attack rolls against targets other than you until the end of your next turn.',
  },
];
