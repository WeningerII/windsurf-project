...
export const warlockInvocations: Feature[] = [
  ...
  },
  {
    ...
    source: 'Warlock',
    description: 'You can now inscribe magical rituals in your Book of Shadows. Choose two 1st-level spells that have the ritual tag. You learn these spells and can cast them as rituals.',
  },
  {
  ...
  },
  {
    ...
    source: 'Warlock',
    description: 'You can use your action to touch a willing humanoid and perceive through its senses until the end of your next turn. As long as the creature is alive and on the same plane of existence as you, you can use your action on subsequent turns to maintain this connection.',
  },
  {
  ...
  },
  {
    ...
    source: 'Warlock',
    description: 'You can communicate telepathically with your familiar and perceive through its senses as long as you are on the same plane of existence. Additionally, while perceiving through it, you can also speak through it in your own voice.',
  },
  {
  ...
  },
  {
    ...
    name: 'Witch Sight',
    source: 'Warlock',
    description: 'You can see the true form of any shapechanger or creature concealed by magic while the creature is within 30 feet of you and within line of sight.',
  },
];
