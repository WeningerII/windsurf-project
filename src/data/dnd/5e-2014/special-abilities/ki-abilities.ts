...
export const kiAbilities: KiAbility[] = [
  ...
  },
  {
    ...
    kiCost: 1,
    minLevel: 1,
    description: 'You can spend 1 ki point to take the Disengage or Dash action as a bonus action on your turn, and your jump distance is tripled until the end of the turn.',
  ...
  },
  {
    ...
    kiCost: 1,
    minLevel: 5,
    description: 'You can spend 1 ki point to try to stun a creature you hit with a melee weapon attack.',
