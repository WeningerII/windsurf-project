...
export const monkKiAbilities: Feature[] = [
  ...
  },
  {
    ...
    source: 'Monk',
    description:
      'You can spend 1 ki point to attempt to stun a creature you hit with a melee weapon attack. The target must succeed on a Constitution saving throw or be stunned until the end of your next turn.',
  },
  {
    ...
    source: 'Monk',
    description:
      'You can regain hit points equal to three times your monk level by spending 1 ki point as an action.',
  },
  {
    id: 'ki-tranquility',
    name: 'Tranquility',
    source: 'Monk',
    description:
      'You can spend 1 ki point to cast sanctuary on yourself, using Wisdom as your spellcasting ability for the spell.',
  },
  {
    id: 'ki-empty-body',
    name: 'Empty Body',
    source: 'Monk',
    description:
      'You can spend 4 ki points to cast invisibility on yourself. You can spend an additional 2 ki points to cast it on one willing creature you can see within 60 feet of you.',
  },
  {
    ...
    source: 'Monk',
    description:
      'You can spend 3 ki points to make a special melee attack. If you hit, the target takes the damage normally and must make a Constitution saving throw. If it fails, it is dying.',
  },
  {
    id: 'ki-diamond-soul',
    name: 'Diamond Soul',
  ...
  },
  {
    ...
    source: 'Monk',
    description:
      'You can spend 4 ki points to cast a spell from the monk spell list without expending a spell slot. The spell must be of a level for which you have spell slots.',
  },
  {
