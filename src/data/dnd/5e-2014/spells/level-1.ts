...
export const level1Spells: Spell[] = [
  ...
  },
  {
    ...
    castingTime: { type: 'action', amount: 1 },
    range: { type: 'self' },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'soot and salt' },
    duration: { type: 'hours', hours: 1 },
    concentration: false,
    ritual: true,
  ...
  },
  {
    ...
    level: 1,
    school: 'transmutation',
    castingTime: { type: 'reaction', amount: 1, condition: 'when you or a creature within 60 feet of you falls' },
    range: { type: 'ranged', feet: 60 },
  ...
  },
  {
    ...
    castingTime: { type: 'minute', amount: 1 },
    range: { type: 'touch' },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'a pearl worth at least 100 gp and an owl feather', materialCost: 100 },
    duration: { type: 'instant' },
    concentration: false,
    ritual: true,
  ...
  },
  {
    ...
    castingTime: { type: 'action', amount: 1 },
    range: { type: 'touch' },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'holy water or powdered silver and iron', materialConsumed: true },
    duration: { type: 'concentration', maxDuration: '10 minutes' },
    concentration: true,
    ritual: false,
  ...
  },
  {
    ...
    level: 1,
    school: 'abjuration',
    castingTime: { type: 'reaction', amount: 1, condition: 'when you are hit by an attack or targeted by the magic missile spell' },
    range: { type: 'self' },
    components: { verbal: true, somatic: true, material: false },
    duration: { type: 'rounds', rounds: 1 },
    concentration: false,
