...
,
  {
    ...
    castingTime: { type: 'action', amount: 1 },
    range: { type: 'touch' },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'gold dust worth at least 25 gp, which the spell consumes', materialCost: 25, materialConsumed: true },
...
,
  {
    ...
    range: { type: 'self' },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'specially marked sticks, bones, or similar tokens worth at least 25 gp', materialCost: 25 },
    duration: { type: 'instant' },
    concentration: false,
    ritual: true,
...
,
  {
    ...
    castingTime: { type: 'action', amount: 1 },
    range: { type: 'touch' },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'ruby dust worth 50 gp, which the spell consumes', materialCost: 50, materialConsumed: true },
    duration: { type: 'permanent' },
    concentration: false,
    ritual: false,
...
,
  {
    ...
    castingTime: { type: 'action', amount: 1 },
    range: { type: 'touch' },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'a pinch of salt and one copper piece placed on each of the corpse\'s eyes, which must remain there for the duration', materialCost: 2 },
...
,
  {
    ...
    castingTime: { type: 'minute', amount: 1 },
    range: { type: 'ranged', feet: 30 },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'a small bit of honeycomb and jade dust worth at least 10 gp, which the spell consumes', materialCost: 10, materialConsumed: true },
    duration: { type: 'permanent' },
    concentration: false,
    ritual: true,
...
,
  {
    ...
    concentration: false,
    ritual: false,
    description: 'You know the magic of animating objects. This spell animates a Tiny nonmagical object within range. As long as the spell lasts, you can use your action each turn to mentally command any creature you animated with this spell if the creature is within 120 feet of you.',
    classes: ['wizard'],
  }
];
