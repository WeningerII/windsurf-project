...
,
  {
    ...
    range: { type: 'touch' },
    components: { verbal: true, somatic: true, material: true, materialDescription: 'a sprinkle of holy water and diamonds worth at least 25,000 gp, which the spell consumes', materialCost: 25000, materialConsumed: true },
    duration: { type: 'instant' },
    concentration: false,
    ritual: false,
...
,
  {
    ...
    components: { verbal: true, somatic: true, material: true, materialDescription: 'a target restraint, solid rope or chain, and a pit at least 5 feet deep' },
    duration: { type: 'special', description: 'until dispelled' },
    concentration: false,
    ritual: false,
    description: 'You create a magical restraint to hold a creature that you can see within range. The target must succeed on a Wisdom saving throw or be bound by the spell; if it succeeds, it can use an action on each of its turns to make another Wisdom saving throw to try to end the effect. While bound, the creature is incapacitated and unable to move or speak except as allowed by you. The spell has no effect on undead or creatures immune to being charmed.',
