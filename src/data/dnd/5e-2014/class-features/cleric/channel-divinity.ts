...
export const channelDivinityOptions: ChannelDivinityOption[] = [
  ...
  },
  {
    ...
    description: 'You can use your Channel Divinity to grant yourself or nearby allies resistance to elemental damage. When you or a creature within 30 feet of you takes acid, cold, fire, lightning, or thunder damage, you can use your reaction to grant resistance to the creature against that instance of the damage.',
    system: 'dnd-5e-2014',
    source: { book: 'SRD 5.1', page: 20 },
    domain: 'nature',
    actionType: 'reaction',
