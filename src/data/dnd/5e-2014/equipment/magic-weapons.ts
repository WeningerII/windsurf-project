...
export const magicWeapons: MagicWeapon[] = [
  ...
  },
  {
    ...
    weaponType: 'javelin',
    specialProperties: [
      'Transforms into lightning bolt',
  ...
  },
  {
    ...
    weaponType: 'longsword',
    specialProperties: [
      'Maximized damage vs objects',
      'Extra 4d6 on critical',
      'Limb severing',
      'Light source',
    ],
    version: '1.0.0',
  },
  {
    ...
    specialProperties: [
      '3 charges',
      'Cast dominate beast on aquatic creatures',
  ...
  },
  {
    ...
    weaponType: 'mace',
    specialProperties: [
      'Extra 2d6 radiant vs fiends/undead',
      'Destroy low HP targets',
      'Frightened on save',
      'Light source',
    ],
    version: '1.0.0',
