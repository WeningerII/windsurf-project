...
export const backpack: Item = {
  id: 'backpack',
  name: 'Backpack',
  system: 'dnd-5e-2014', source: 'SRD 5.1',   type: 'gear',
  rarity: 'common',
  weight: 5,
...
export const crowbar: Item = {
  id: 'crowbar',
  name: 'Crowbar',
  system: 'dnd-5e-2014', source: 'SRD 5.1',   type: 'tool',
  rarity: 'common',
  weight: 5,
  cost: { amount: 2, currency: 'gp' },
...
export const manacles: Item = {
  ...
  weight: 6,
  cost: { amount: 2, currency: 'gp' },
  description: 'These metal restraints can bind a Small or Medium creature. Escaping the manacles requires a successful DC 20 Dexterity check. Breaking them requires a successful DC 20 Strength check. Each set of manacles comes with one key.',
  requiresAttunement: false,
};
...
export const acidVial: Item = {
  ...
  weight: 1,
  cost: { amount: 25, currency: 'gp' },
  description: 'As an action, you can splash the contents of this vial onto a creature within 5 feet of you or throw the vial up to 20 feet, shattering it on impact. Make a ranged attack against a creature or object, treating the acid as an improvised weapon. On a hit, the target takes 2d6 acid damage.',
  requiresAttunement: false,
};
...
export const ropeSilk: Item = {
  ...
  weight: 5,
  cost: { amount: 10, currency: 'gp' },
  description: 'Rope made from silk, lighter and stronger than hemp rope. Has 2 hit points and can be burst with a DC 17 Strength check.',
  requiresAttunement: false,
};
...
export const forgeryKit: Item = {
  ...
  weight: 5,
  cost: { amount: 15, currency: 'gp' },
  description: 'This small box contains a variety of papers and parchments, pens and inks, seals and sealing wax, gold and silver leaf, and other supplies necessary to create convincing forgeries of physical documents.',
  requiresAttunement: false,
};
...
export const navigatorsTools: Item = {
  ...
  weight: 2,
  cost: { amount: 25, currency: 'gp' },
  description: 'This set of instruments is used for navigation at sea. Proficiency with navigator\'s tools lets you chart a ship\'s course and follow navigation charts.',
  requiresAttunement: false,
};
