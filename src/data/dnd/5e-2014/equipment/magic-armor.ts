...
export const magicArmor: MagicArmor[] = [
  ...
  },
  {
    ...
    description:
      'You have resistance to one type of damage while you wear this armor. The GM chooses the type or determines it randomly from the options: acid, cold, fire, force, lightning, necrotic, poison, psychic, radiant, or thunder.',
    system: 'dnd-5e-2014',
    source: { book: 'SRD 5.1', page: 152 },
    type: 'armor',
    rarity: 'rare',
