...
export const dwarf: Species = {
  ...
  traits: [
    ...
    },
    {
      ...
      name: 'Stonecunning',
      source: 'Dwarf',
      description: 'As a Bonus Action, you can give yourself Tremorsense with a range of 60 feet for 10 minutes. You must be on a stone surface or touching a stone surface to use this Tremorsense. You can use this Bonus Action a number of times equal to your Proficiency Bonus, and you regain all expended uses when you finish a Long Rest.',
    },
  ],
