...
export const dragonborn: Species = {
  ...
  traits: [
    ...
    },
    {
      ...
      source: 'Dragonborn',
      description: 'When you reach 5th level, you can channel draconic magic to give yourself temporary flight. As a Bonus Action, you sprout spectral wings on your back that last for 10 minutes or until you retract them (no action required). During that time, you have a Fly Speed equal to your Speed. Your wings appear to be made of the same energy as your Breath Weapon. Once you use this trait, you can\'t use it again until you finish a Long Rest.',
    },
  ],
