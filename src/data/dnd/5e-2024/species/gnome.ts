...
export const gnome: Species = {
  ...
  traits: [
    ...
    },
    {
      ...
      source: 'Gnome',
      description:
        "You are part of a gnomish lineage that grants you supernatural abilities. Choose one of the following options: Forest Gnome (you know the Minor Illusion cantrip) or Rock Gnome (you have proficiency with Artisan's Tools of your choice).",
    },
  ],
