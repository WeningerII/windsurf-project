      ...
      features: [
        {
          ...
          name: 'Rage',
          source: 'Barbarian 1',
          description: 'In battle, you fight with primal ferocity. On your turn, you can enter a rage as a bonus action. While raging, you gain benefits including advantage on Strength checks and saving throws, bonus damage, and resistance to physical damage.',
          uses: {
            current: 2,
            max: 2,
        ...
        },
        {
          ...
          name: 'Weapon Mastery',
          source: 'Barbarian 1',
          description: 'Your training with weapons allows you to use the mastery property of two kinds of Simple or Martial Melee weapons of your choice.',
        },
      ],
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          name: 'Danger Sense',
          source: 'Barbarian 2',
          description: 'At 2nd level, you gain an uncanny sense of when things nearby aren\'t as they should be, giving you advantage on Dexterity saving throws against effects you can see.',
        },
      ],
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          source: 'Barbarian 3',
          description: 'When you reach 3rd level, you gain proficiency in one skill of your choice from the barbarian skill list.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Barbarian 11',
          description: 'Starting at 11th level, your rage can keep you fighting despite grievous wounds.',
        },
      ],
    },
    {
