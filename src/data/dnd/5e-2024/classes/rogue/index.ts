...
export const rogue: CharacterClass = {
  ...
  equipmentChoices: [
    ...
    {
      choose: 1,
      options: [['shortbow', 'arrows-20'], ['shortsword']],
    },
    {
      choose: 1,
      options: [['burglars-pack'], ['dungeoneers-pack'], ['explorers-pack']],
    },
    {
      choose: 1,
      options: [['leather-armor', 'dagger', 'dagger', 'thieves-tools']],
    },
  ],
      ...
      features: [
        {
          ...
          source: 'Rogue 1',
          description:
            "Choose two of your skill proficiencies or one skill and your proficiency with Thieves' Tools. Your Proficiency Bonus is doubled for any ability check you make using the chosen proficiencies. At 6th level, you can choose two more proficiencies to gain this benefit.",
        },
        {
          id: 'sneak-attack',
          name: 'Sneak Attack',
          source: 'Rogue 1',
          description:
            "Once per turn, you can deal extra damage to one creature you hit with an attack roll if you're attacking with a Finesse or Ranged weapon and have Advantage on the attack roll. The extra damage is 1d6 and increases as you gain Rogue levels.",
        },
        {
          id: 'thieves-cant',
          name: "Thieves' Cant",
        ...
        },
        {
          ...
          source: 'Rogue 1',
          description:
            'Your training with weapons allows you to use the mastery property of two kinds of Simple or Martial weapons of your choice.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          source: 'Rogue 3',
          description:
            "As a Bonus Action, you give yourself Advantage on your next attack roll on the current turn. You can use this feature only if you haven't moved during this turn and you aren't using your Speed.",
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Rogue 4',
          description:
            "Increase one ability score by 2, or increase two ability scores by 1. You can't increase an ability score above 20 using this feature.",
        },
      ],
    },
    {
