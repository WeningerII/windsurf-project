  ...
  features: [
    {
      ...
      features: [
        ...
        },
        {
          ...
          source: 'Life Domain 3',
          description: 'Your connection to this domain ensures you always have certain spells ready. When you reach a Cleric level specified in the Life Domain Spells table, you thereafter always have the listed spells prepared. These spells don\'t count against the number of spells you can prepare, and they are considered Cleric spells for you.',
        },
      ],
    },
    {
