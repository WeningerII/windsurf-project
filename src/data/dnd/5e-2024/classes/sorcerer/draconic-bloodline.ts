      ...
      features: [
        {
          ...
          description: 'Magic flows through your body, and physical traits of your dragon ancestors emerge. Your Hit Point maximum increases by 3, and it increases by 1 again whenever you gain a Sorcerer level. Additionally, parts of your skin are covered by a thin sheen of dragon-like scales. When you aren\'t wearing armor, your AC equals 13 + your Dexterity modifier.',
        },
        {
          id: 'dragon-speech',
          name: 'Dragon Speech',
          source: 'Draconic Sorcery 3',
          description: 'You can speak, read, and write Draconic. In addition, when you make a Charisma check to interact with Dragons, you have Advantage on the check.',
        },
        {
          id: 'draconic-spells',
          name: 'Draconic Spells',
          source: 'Draconic Sorcery 3',
          description: 'You learn the following spells. They are Sorcerer spells for you, but they don\'t count against your number of Sorcerer spells known. If you later replace a spell, you must replace it with a spell from the Sorcerer spell list that deals the same damage type as the one you are replacing.\n\nLevel 1: Chromatic Orb, Command\nLevel 3: Dragon\'s Breath, Hold Person\nLevel 5: Fear, Fly\nLevel 7: Charm Monster, Elemental Bane\nLevel 9: Dominate Person, Legend Lore',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          description: 'You can use a Bonus Action to sprout a pair of dragon wings from your back. While the wings are present, you have a Fly Speed of 60 feet. You can dismiss the wings as a Bonus Action. You can\'t manifest your wings while wearing armor unless the armor is made to accommodate them, and clothing not made to accommodate your wings might be destroyed when you manifest them.',
        },
      ],
    },
    {
