      ...
      features: [
        {
          ...
          description: 'You can cast one of your Circle Spells without expending a spell slot. You can do so a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          description: 'You are immune to the Poisoned condition, and you have Resistance to Poison damage. Additionally, you are immune to disease.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          description: 'Creatures of the Plant and Beast types have Disadvantage on attack rolls against you. In addition, you have Resistance to the damage type associated with your chosen land: Fire (Arid), Cold (Polar), Lightning (Temperate), or Poison (Tropical).',
        },
      ],
    },
  ],
