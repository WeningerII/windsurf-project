    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          source: 'Fighter 2',
          description:
            'You have a mind for tactics. When you fail an ability check, you can expend a use of your Action Surge to succeed instead.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          source: 'Fighter 5',
          description:
            'Whenever you activate your Action Surge, you can move up to half your Speed (no action required) before or after the extra action.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          source: 'Fighter 9',
          description:
            "You are adept at using any weapon in any circumstance. You ignore the Loading property of weapons you are proficient with, and you don't need a free hand to reload.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          source: 'Fighter 13',
          description:
            'You study your opponents and learn from each attack you make. If you miss with an attack roll, you gain a +1 bonus to your next attack roll against that creature before the end of your next turn.',
        },
      ],
    },
    {
