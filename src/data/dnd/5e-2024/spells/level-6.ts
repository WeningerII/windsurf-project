...
export const level6Spells: Spell[] = [
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You create linked teleportation portals that remain open for the duration. Choose two points on the ground that you can see, one point within 10 feet and one within 500 feet.",
    "classes": [
      "sorcerer",
      "warlock",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You create a vertical wall of whirling, razor-sharp blades made of magical energy. Any creature that enters the wall's area for the first time or starts its turn there must make a Dexterity saving throw, taking 6d10 Slashing damage on a failed save.",
    "classes": [
      "cleric"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You hurl a bolt of lightning at a creature of your choice that you can see within range. The target must make a Dexterity saving throw. On a failed save, the creature takes 10d8 lightning damage. On a successful save, it takes half as much damage. The lightning arcs from that creature to up to three other creatures within 30 feet of it that you can see. Each of those creatures must make a Dexterity saving throw.",
    "atHigherLevels": "When you cast this spell using a spell slot of 7th level or higher, the number of secondary targets increases by one for each slot level above 6th.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A sphere of negative energy ripples out in a 60-foot-radius Sphere from a point within range. Each creature in that area must make a Constitution saving throw, taking 8d6 Necrotic damage on a failed save.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 7 or higher, the damage increases by 2d6 for each slot level above 6.",
    "classes": [
      "sorcerer",
      "warlock",
      "wizard"
  ...
  },
  {
    ...
    "components": {
      ...
      "somatic": true,
      "material": true,
      "materialDescription": "burning incense for air, soft clay for earth, salt water for water, or sulfur for fire"
    },
    "duration": {
      "type": "concentration",
      "maxDuration": "1 hour"
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "Choose a spell of level 5 or lower that you can cast, that has a casting time of 1 action, and that can target you. You cast that spell—called the contingent spell—as part of casting contingency, expending spell slots for both.",
    "classes": [
      "wizard"
    ]
  },
  {
    ...
    "components": {
      ...
      "somatic": true,
      "material": true,
      "materialDescription": "a clay pot with grave dirt and a black onyx stone worth 150 gp per corpse",
      "materialCost": 150
    },
    "duration": {
      "type": "instant"
    ...
    "atHigherLevels": "When you cast this spell using a level 7 slot, you can create Ghasts. Level 8: Wights. Level 9: Mummies.",
    "classes": [
      "cleric",
      "warlock",
      "wizard"
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A thin green ray springs from your pointing finger to a target within range. The target can be a creature, an object, or a creation of magical force. A creature takes 10d6 + 40 Force damage. If this damage reduces the creature to 0 HP, it is disintegrated.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 7 or higher, the damage increases by 3d6 for each slot level above 6.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "For the spell's duration, your eyes become an inky void imbued with dread power. One creature of your choice within 60 feet must succeed on a Wisdom saving throw or be affected by one of these effects: Asleep, Panicked, or Sickened.",
    "classes": [
      "bard",
      "sorcerer",
      "warlock",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You attempt to turn one creature that you can see within range into stone. The target must make a Constitution saving throw. On a failed save, it has the Restrained condition as its flesh begins to harden.",
    "classes": [
      "druid",
      "sorcerer",
      "warlock",
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You protect a location with an interdiction spell. The spell can cover an area up to 40,000 square feet. If you cast the spell on a natural terrain, it affects a quarter-mile radius. If you cast it on a structure or ship, it affects only the interior.",
    "classes": [
      "cleric"
    ]
  },
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "An immobile, faintly shimmering barrier springs into existence in a 10-foot-radius Sphere around you. Any spell of level 5 or lower cast from outside the barrier can't affect creatures or objects within it.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 7 or higher, the barrier blocks spells of one level higher for each slot level above 6.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  },
  {
    ...
    "components": {
      ...
      "somatic": true,
      "material": true,
      "materialDescription": "burning incense, a small measure of powdered silver, and a piece of iron or steel"
    },
    "duration": {
      "type": "hours",
      "hours": 24
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You unleash a virulent disease on a creature that you can see within range. The target must make a Constitution saving throw. On a failed save, it takes 14d6 Necrotic damage, and its HP maximum is reduced by an amount equal to the damage taken.",
    "classes": [
      "cleric"
    ]
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 7 or higher, the healing increases by 10 for each slot level above 6.",
    "classes": [
      "cleric",
      "druid"
    ]
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You suggest a course of activity to up to twelve creatures of your choice that you can see within range and that can hear and understand you. The suggestion must be worded reasonably.",
    "atHigherLevels": "When you cast this spell using a level 7 slot, the duration is 10 days. Level 8: 30 days. Level 9: a year and a day.",
    "classes": [
      "bard",
      "sorcerer",
      "warlock",
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A frigid globe of cold energy streaks from your fingertips to a point within range, where it explodes in a 60-foot-radius Sphere. Each creature in the Sphere makes a Constitution saving throw, taking 10d6 Cold damage on a failed save.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 7 or higher, the damage increases by 1d6 for each slot level above 6.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "A beam of brilliant light flashes out from your hand in a 5-foot-wide, 60-foot-long Line. Each creature in the Line must make a Constitution saving throw, taking 6d8 Radiant damage on a failed save and has the Blinded condition until your next turn.",
    "classes": [
      "cleric",
      "druid",
      "sorcerer",
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "This spell gives the willing creature you touch Truesight with a range of 120 feet for the duration.",
    "classes": [
      "bard",
      "cleric",
      "sorcerer",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You create a wall of ice on a solid surface within range. You can form it into a hemispherical dome or a sphere with a radius up to 10 feet, or shape it as a flat surface made up of ten 10-foot-square panels.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 7 or higher, the damage increases by 2d6 for each slot level above 6.",
    "classes": [
      "wizard"
    ]
