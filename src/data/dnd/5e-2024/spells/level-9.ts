...
export const level9Spells: Spell[] = [
  ...
  },
  {
    ...
    ritual: false,
    description:
      'You assume the form of a different creature for the duration. The new form can be of any creature with a Challenge Rating equal to or less than your level.',
  ...
  },
  {
    ...
    ritual: false,
    description:
      'You touch a creature that has been dead for no longer than 200 years and that died for any reason except old age. The creature is restored to life with all its Hit Points.',
