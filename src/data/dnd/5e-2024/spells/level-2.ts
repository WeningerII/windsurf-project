...
export const level2Spells: Spell[] = [
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A shimmering green arrow streaks toward a target within range. Make a ranged spell attack against the target. On a hit, the target takes 4d4 Acid damage immediately and 2d4 Acid damage at the end of its next turn.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, the damage increases by 1d4 for each slot level above 2.",
    "classes": [
      "wizard"
    ]
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, the bonus increases by 5 for each slot level above 2.",
    "classes": [
      "bard",
      "cleric",
      "druid",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You assume a different form. When you cast the spell, choose Aquatic Adaptation, Change Appearance, or Natural Weapons.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You touch a willing creature. Until the spell ends, the target's skin takes on a rough, bark-like appearance, and the target's AC can't be less than 17, regardless of armor worn.",
    "classes": [
      "druid",
      "ranger"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "One creature that you can see within range must make a Constitution saving throw. On a failed save, the target has the Blinded or Deafened condition (your choice) for the duration. At the end of each of its turns, the target repeats the save, ending the spell on itself on a success.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, you can target one additional creature for each slot level above 2.",
    "classes": [
      "bard",
      "cleric",
      "sorcerer",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You attempt to suppress strong emotions. Each Humanoid in a 20-foot-radius Sphere centered on a point you choose must make a Charisma saving throw. You can suppress Charmed/Frightened conditions or make targets Indifferent.",
    "classes": [
      "bard",
      "cleric"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A flame springs forth from an object that you touch. The effect looks like a regular flame, but it creates no heat and doesn't use oxygen. A continual flame can be covered or hidden but not smothered or quenched.",
    "classes": [
      "cleric",
      "druid",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "Magical Darkness spreads from a point you choose within range to fill a 15-foot-radius Sphere for the duration. Darkvision can't see through it, and nonmagical light can't illuminate it.",
    "classes": [
      "sorcerer",
      "warlock",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "For the duration, you can sense the presence and location of any creature within 30 feet of you that has Intelligence 4 or higher. You can focus your mind on one creature to learn its surface thoughts.",
    "classes": [
      "bard",
      "sorcerer",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You touch a creature and choose Strength, Dexterity, Constitution, Intelligence, Wisdom, or Charisma. For the duration, the target has Advantage on ability checks using that ability.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, you can target one additional creature for each slot level above 2.",
    "classes": [
      "bard",
      "cleric",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You cause a creature or an object you can see within range to grow larger or smaller for the duration. Choose Enlarge or Reduce.",
    "classes": [
      "bard",
      "sorcerer",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You evoke a fiery blade in your free hand. The blade is similar in size and shape to a scimitar, and it lasts for the duration. You can use your action to make a melee spell attack, dealing 3d6 Fire damage on a hit.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 4 or higher, the damage increases by 1d6 for every 2 slot levels above 2.",
    "classes": [
      "druid",
      "sorcerer"
    ]
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "A 5-foot-diameter sphere of fire appears in an unoccupied space. Any creature that ends its turn within 5 feet of the sphere must make a Dexterity saving throw, taking 2d6 Fire damage on a failed save.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, the damage increases by 1d6 for each slot level above 2.",
    "classes": [
      "druid",
      "sorcerer",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "A line of strong wind 60 feet long and 10 feet wide blasts from you in a direction you choose. Each creature that starts its turn in the line must succeed on a Strength saving throw or be pushed 15 feet away from you.",
    "classes": [
      "druid",
      "ranger",
      "sorcerer",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "Choose a Humanoid that you can see within range. The target must succeed on a Wisdom saving throw or have the Paralyzed condition for the duration. At the end of each of its turns, the target repeats the save.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, you can target one additional Humanoid for each slot level above 2.",
    "classes": [
      "bard",
      "cleric",
      "druid",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "A creature you touch has the Invisible condition until the spell ends. Anything the target is wearing or carrying is invisible as long as it is on the target's person. The spell ends for a target that attacks or casts a spell.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, you can target one additional creature for each slot level above 2.",
    "classes": [
      "bard",
      "sorcerer",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "One creature or object of your choice that you can see within range rises vertically, up to 20 feet, and remains suspended there for the duration. An unwilling creature that succeeds on a Constitution saving throw is unaffected.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  ...
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 4 or higher, the bonus increases to +2. With a level 6 or higher slot, the bonus increases to +3.",
    "classes": [
      "paladin",
      "ranger",
      "sorcerer",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "A veil of shadow and silence radiates from you, masking you and your companions from detection. For the duration, each creature you choose within 30 feet of you has a +10 bonus to Dexterity (Stealth) checks.",
    "classes": [
      "druid",
      "ranger"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "Up to five creatures of your choice that are within range at the end of the casting each regain Hit Points equal to 2d8 plus your spellcasting ability modifier.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, the healing increases by 1d8 for each slot level above 2.",
    "classes": [
      "cleric",
      "paladin"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You touch a creature and end the Poisoned condition on it. For the duration, the target has Advantage on saving throws against being poisoned and has Resistance to Poison damage.",
    "classes": [
      "cleric",
      "druid",
      "paladin",
  ...
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, you create one additional ray for each slot level above 2.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "For the duration, you see creatures and objects that have the Invisible condition as if they were visible, and you can see into the Ethereal Plane.",
    "classes": [
      "bard",
      "sorcerer",
      "wizard"
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A sudden loud ringing noise, painfully intense, erupts from a point of your choice within range. Each creature in a 10-foot-radius Sphere centered on that point must make a Constitution saving throw, taking 3d8 Thunder damage on a failed save.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 3 or higher, the damage increases by 1d8 for each slot level above 2.",
    "classes": [
      "bard",
      "sorcerer",
      "warlock",
