...
export const level1Spells: Spell[] = [
  {
    ...
    "concentration": false,
    "ritual": true,
    "description": "You set an alarm against intrusion. Choose a door, window, or an area within range no larger than a 20-foot cube. Until the spell ends, an alarm alerts you whenever a creature touches or enters the warded area.",
    "classes": [
      "ranger",
      "wizard"
    ]
  ...
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, you can target one additional creature for each slot level above 1.",
    "classes": [
      "cleric",
      "paladin"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "As you hold your hands with thumbs touching and fingers spread, a thin sheet of flames shoots forth. Each creature in a 15-foot Cone makes a Dexterity saving throw, taking 3d6 Fire damage on a failed save, or half as much on a successful one.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the damage increases by 1d6 for each slot level above 1.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You attempt to charm a Humanoid you can see within range. It must make a Wisdom saving throw, and does so with Advantage if you or your companions are fighting it. If it fails, it has the Charmed condition until the spell ends or until you or your companions do anything harmful to it.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, you can target one additional creature for each slot level above 1.",
    "classes": [
      "bard",
      "druid",
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A dazzling array of flashing, colored light springs from your hand. Each creature in a 15-foot Cone must succeed on a Constitution saving throw or have the Blinded condition until the end of your next turn.",
    "classes": [
      "bard",
      "sorcerer",
      "wizard"
  ...
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, you create or destroy 10 additional gallons of water, or the size of the cube increases by 5 feet, for each slot level above 1.",
    "classes": [
      "cleric",
      "druid"
    ]
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the healing increases by 1d8 for each slot level above 1.",
    "classes": [
      "bard",
      "cleric",
      "druid",
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": true,
    "description": "For the duration, you can sense the presence and location of poisons, poisonous creatures, and diseases within 30 feet of you. You identify the type of poison, poisonous creature, or disease in each case.",
    "classes": [
      "cleric",
      "druid",
      "paladin",
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You make yourself—including your clothing, armor, weapons, and other belongings on your person—look different until the spell ends or until you use your action to dismiss it. You can seem up to 1 foot shorter or taller and can appear thin, fat, or in between.",
    "classes": [
      "bard",
      "sorcerer",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "This spell allows you to move at an incredible pace. When you cast this spell and as a Bonus Action on each of your subsequent turns until the spell ends, you can take the Dash action.",
    "classes": [
      "sorcerer",
      "warlock",
      "wizard"
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "Bolstering yourself with a necromantic facsimile of life, you gain 2d4 + 4 Temporary Hit Points.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, you gain 5 additional Temporary Hit Points for each slot level above 1.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "Choose up to five falling creatures within range. A falling creature's rate of descent slows to 60 feet per round until the spell ends. If the creature lands before the spell ends, it takes no falling damage, and the spell ends for that creature.",
    "classes": [
      "bard",
      "sorcerer",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You create a 20-foot-radius Sphere of fog centered on a point within range. The Sphere is Heavily Obscured. It lasts for the duration or until a strong wind disperses it.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the radius increases by 20 feet for each slot level above 1.",
    "classes": [
      "druid",
      "ranger",
      "sorcerer",
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "Up to ten berries appear in your hand. A creature can use a Bonus Action to eat one berry. Eating a berry restores 1 Hit Point, and the berry provides enough nourishment to sustain a creature for one day. The berries lose their potency after 24 hours.",
    "classes": [
      "druid",
      "ranger"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "Slick grease covers the ground in a 10-foot square centered on a point within range and turns it into Difficult Terrain. When the grease appears, each creature standing in its area must succeed on a Dexterity saving throw or have the Prone condition.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A flash of light streaks toward a creature of your choice within range. Make a ranged spell attack. On a hit, the target takes 4d6 Radiant damage, and the next attack roll made against it before the end of your next turn has Advantage.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the damage increases by 1d6 for each slot level above 1.",
    "classes": [
      "cleric"
    ]
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the healing increases by 2d4 for each slot level above 1.",
    "classes": [
      "bard",
      "cleric",
      "druid"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "You place a curse on a creature that you can see within range. Until the spell ends, you deal an extra 1d6 Necrotic damage to the target whenever you hit it with an attack. Also, choose one ability. The target has Disadvantage on ability checks made with that ability.",
    "atHigherLevels": "When you cast this spell using a level 3-4 spell slot, you can maintain Concentration for up to 8 hours. With a level 5+ slot, you can maintain Concentration for up to 24 hours.",
    "classes": [
      "warlock"
    ]
  },
  ...
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the damage increases by 1d10 for each slot level above 1.",
    "classes": [
      "cleric"
    ]
  },
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "You touch a willing creature who isn't wearing armor. Until the spell ends, the target's base AC becomes 13 + its Dexterity modifier. The spell ends early if the target dons armor or if you dismiss the spell.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the spell creates one more dart for each slot level above 1.",
    "classes": [
      "sorcerer",
      "wizard"
    ]
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "Until the spell ends, one willing creature you touch is protected against certain creatures: Aberrations, Celestials, Elementals, Fey, Fiends, and Undead. The protection grants several benefits against those creature types.",
    "classes": [
      "cleric",
      "druid",
      "paladin",
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A ray of sickening greenish energy springs from your fingertip toward a creature within range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 poison damage and must make a Constitution saving throw. On a failed save, it is poisoned until the end of your next turn.",
    "atHigherLevels": "When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d8 for each slot level above 1st.",
    "classes": [
      "sorcerer",
      "wizard"
  ...
  },
  {
    ...
    "concentration": true,
    "ritual": false,
    "description": "Each creature of your choice within 5 feet of a point you choose must succeed on a Wisdom saving throw or have the Incapacitated condition until the spell ends, the sleeper takes damage, or someone uses an action to wake it.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, you can target one additional creature for each slot level above 1.",
    "classes": [
      "bard",
      "sorcerer",
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": true,
    "description": "You gain the ability to comprehend and verbally communicate with Beasts for the duration. The knowledge and awareness of many Beasts is limited by their intelligence, but at minimum, they can give you information about nearby locations and monsters.",
    "classes": [
      "bard",
      "druid",
      "ranger"
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": true,
    "description": "You create a circular, horizontal plane of force, 3 feet in diameter and 1 inch thick, that floats 3 feet above the ground in an unoccupied space of your choice that you can see within range. The disk remains for the duration. It can hold up to 500 pounds. If you move more than 100 feet away from the disk, the spell ends.",
    "classes": [
      "wizard"
    ]
  },
  ...
  },
  {
    ...
    "concentration": false,
    "ritual": false,
    "description": "A wave of thunderous force sweeps out from you. Each creature in a 15-foot Cube originating from you must make a Constitution saving throw. On a failed save, a creature takes 2d8 Thunder damage and is pushed 10 feet away from you. On a successful save, the creature takes half as much damage.",
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the damage increases by 1d8 for each slot level above 1.",
    "classes": [
      "bard",
      "druid",
      "sorcerer",
  ...
  },
  {
    ...
    "atHigherLevels": "When you cast this spell using a spell slot of level 2 or higher, the initial damage increases by 1d12 for each slot level above 1.",
    "classes": [
      "sorcerer",
      "warlock",
      "wizard"
