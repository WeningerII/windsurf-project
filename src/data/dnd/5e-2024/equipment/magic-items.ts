...
export const alchemy: Item = {
  id: 'alchemy-jug',
  name: 'Alchemy Jug',
  system: 'dnd-5e-2024', source: 'SRD 5.2',   type: 'magic-item',
  rarity: 'uncommon',
  weight: 3,
...
export const potionOfHealing: Item = {
  ...
  system: 'dnd-5e-2024', source: 'SRD 5.2',   type: 'consumable',
  rarity: 'common',
  weight: 0.5,
...
// 104 magic items currently implemented from SRD 5.2
...
export const dnd5e2024MagicItems: Item[] = [
  ...
  beltOfGiantStrength,
  beltOfDwarven,
  // Wondrous Items - Amulets
  amuletOfHealth,
  amuletOfProof,
  amuletOfThePlanes,
  // Wondrous Items - Headgear
  helmOfTelepathy,
  helmOfComprehending,
  helmOfTeleportation,
  // Wondrous Items - Bracers
  bracersOfDefense,
  bracersOfArchery,
  // Wondrous Items - Eyes
  eyesOfCharming,
