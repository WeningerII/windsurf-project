...
export const burglarsPack: Item = {
  id: 'burglars-pack',
  name: 'Burglar\'s Pack',
  system: 'dnd-5e-2024', source: 'SRD 5.2',   type: 'gear',
  rarity: 'common',
  weight: 44, // Estimate
...
export const thievesTools: Item = {
  id: 'thieves-tools',
  name: 'Thieves\' Tools',
  system: 'dnd-5e-2024', source: 'SRD 5.2',   type: 'tool',
  rarity: 'common',
  weight: 1,
...
export const tinderbox: Item = {
  ...
  weight: 1,
  cost: { amount: 5, currency: 'sp' },
  description: 'This small container holds flint, fire steel, and tinder used to kindle a fire. Lighting a torch takes an action. Lighting any other fire takes 1 minute.',
  requiresAttunement: false,
};
...
export const lantern: Item = {
  ...
  weight: 2,
  cost: { amount: 5, currency: 'gp' },
  description: 'A hooded lantern casts bright light in a 30-foot radius and dim light for an additional 30 feet. Once lit, it burns for 6 hours on a flask of oil.',
  requiresAttunement: false,
};
...
export const oil: Item = {
  ...
  description: 'Oil can be splashed on a creature within 5 feet or thrown up to 20 feet. On a hit, the target is covered in oil. If the target takes fire damage, it takes an additional 5 fire damage from burning oil.',
  requiresAttunement: false,
};
...
export const componentPouch: Item = {
  ...
  weight: 2,
  cost: { amount: 25, currency: 'gp' },
  description: 'A component pouch holds all the material components needed to cast spells, except those that have a specific cost.',
  requiresAttunement: false,
};
...
export const holySymbol: Item = {
  ...
  weight: 1,
  cost: { amount: 5, currency: 'gp' },
  description: 'A holy symbol is a representation of a god or pantheon. A cleric or paladin can use a holy symbol as a spellcasting focus.',
  requiresAttunement: false,
};
...
export const druidicFocus: Item = {
  ...
  weight: 1,
  cost: { amount: 5, currency: 'gp' },
  description: 'A druidic focus might be a sprig of mistletoe, a wand made of special wood, or a totem object. A druid can use it as a spellcasting focus.',
  requiresAttunement: false,
};
...
export const healersKit: Item = {
  ...
  weight: 3,
  cost: { amount: 5, currency: 'gp' },
  description: 'This kit has ten uses. As an action, you can expend one use to stabilize a creature that has 0 hit points.',
  requiresAttunement: false,
};
...
export const climbersKit: Item = {
  ...
  weight: 12,
  cost: { amount: 25, currency: 'gp' },
  description: 'Includes special pitons, boot tips, gloves, and a harness. You can anchor yourself to prevent falling more than 25 feet.',
  requiresAttunement: false,
};
...
export const messKit: Item = {
  ...
  weight: 1,
  cost: { amount: 2, currency: 'sp' },
  description: 'This tin box contains a cup and simple cutlery. One side can be used as a cooking pan.',
  requiresAttunement: false,
};
...
export const lockItem: Item = {
  ...
  weight: 1,
  cost: { amount: 10, currency: 'gp' },
  description: 'A key is provided with the lock. Without the key, the lock can be picked with a DC 15 Dexterity check using thieves\' tools.',
  requiresAttunement: false,
};
...
export const manacles: Item = {
  ...
  weight: 6,
  cost: { amount: 2, currency: 'gp' },
  description: 'These metal restraints can bind a Small or Medium creature. Escaping requires a DC 20 Dexterity check. Breaking requires a DC 20 Strength check.',
  requiresAttunement: false,
};
...
export const book: Item = {
  ...
  weight: 5,
  cost: { amount: 25, currency: 'gp' },
  description: 'A book might contain poetry, historical accounts, lore, diagrams, or anything else represented in text or pictures.',
  requiresAttunement: false,
};
...
export const disguiseKit: Item = {
  ...
  weight: 3,
  cost: { amount: 25, currency: 'gp' },
  description: 'This pouch of cosmetics, hair dye, and small props lets you create disguises. Proficiency with this kit lets you add your proficiency bonus to checks made to create a visual disguise.',
  requiresAttunement: false,
};
...
export const poisonersKit: Item = {
  ...
  weight: 2,
  cost: { amount: 50, currency: 'gp' },
  description: 'Includes vials, chemicals, and other equipment necessary for creating poisons. Proficiency with this kit lets you add your proficiency bonus to checks made to craft or use poisons.',
  requiresAttunement: false,
};
