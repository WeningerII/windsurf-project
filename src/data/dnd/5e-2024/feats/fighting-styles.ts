...
//
// SRD 5.2 includes four Fighting Style feats: Archery, Defense, Great Weapon
// Fighting, and Two-Weapon Fighting. The other fighting styles are Player's
// Handbook content (not open) and are intentionally excluded.
