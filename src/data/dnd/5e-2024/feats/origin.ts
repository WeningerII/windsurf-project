...
export const crafter: FeatDefinition = {
  ...
  benefits: [
    ...
    'Faster Crafting: When you craft an item using a tool with which you have proficiency, reduce the crafting time by 20%.',
  ],
};
...
export const healer: FeatDefinition = {
  ...
  source: 'SRD 5.2',
  description:
    'You have the training and intuition to administer first aid and other care effectively.',
  benefits: [
    "Battle Medic: If you have a Healer's Kit, you can expend one use of it and tend to a creature within 5 feet. That creature regains 2d4 + 2 HP.",
    'Healing Rerolls: Whenever you roll a die to determine HP restored, you can reroll the die if it rolls a 1, and you must use the new roll.',
  ],
};
...
export const lucky: FeatDefinition = {
  ...
  benefits: [
    ...
    'Advantage: Spend 1 Luck Point when you make a d20 Test to give yourself Advantage.',
    'Disadvantage to Attacker: Spend 1 Luck Point when a creature makes an attack roll against you to impose Disadvantage on that roll.',
    'Regain Points: You regain all expended Luck Points when you finish a Long Rest.',
  ],
};
...
export const magicInitiateBard: FeatDefinition = {
  ...
  source: 'SRD 5.2',
  description:
    'You have learned the basics of a particular magical tradition from the Bard spell list.',
  benefits: [
    'Two Cantrips: You learn two cantrips of your choice from the Bard spell list.',
    'Level 1 Spell: You learn one level 1 spell of your choice from the Bard spell list. You can cast it once without a spell slot, regaining the ability after a Long Rest.',
    'Spell Change: Whenever you gain a new level, you can replace one spell from this feat.',
  ],
};
...
export const magicInitiateSorcerer: FeatDefinition = {
  ...
  source: 'SRD 5.2',
  description:
    'You have learned the basics of a particular magical tradition from the Sorcerer spell list.',
  benefits: [
    'Two Cantrips: You learn two cantrips of your choice from the Sorcerer spell list.',
    'Level 1 Spell: You learn one level 1 spell of your choice from the Sorcerer spell list. You can cast it once without a spell slot, regaining the ability after a Long Rest.',
    'Spell Change: Whenever you gain a new level, you can replace one spell from this feat.',
  ],
};
...
export const magicInitiateWarlock: FeatDefinition = {
  ...
  source: 'SRD 5.2',
  description:
    'You have learned the basics of a particular magical tradition from the Warlock spell list.',
  benefits: [
    'Two Cantrips: You learn two cantrips of your choice from the Warlock spell list.',
    'Level 1 Spell: You learn one level 1 spell of your choice from the Warlock spell list. You can cast it once without a spell slot, regaining the ability after a Long Rest.',
    'Spell Change: Whenever you gain a new level, you can replace one spell from this feat.',
  ],
};
...
export const musician: FeatDefinition = {
  ...
  benefits: [
    ...
    'Inspiring Song: As you finish a Short or Long Rest, you can play a song on a Musical Instrument and give Heroic Inspiration to allies who hear the song.',
  ],
};
...
export const tavern_brawler: FeatDefinition = {
  ...
  benefits: [
    ...
    'Damage Rerolls: When you roll a damage die for your Unarmed Strike, you can reroll the die if it rolls a 1, and you must use the new roll.',
    'Shove: When you hit a creature with your Unarmed Strike as part of the Attack action, you can deal damage and also push the creature 5 feet away. You can use this benefit only once per turn.',
...
export const tough: FeatDefinition = {
  ...
  benefits: [
    'Hit Point Increase: Your Hit Point maximum increases by an amount equal to twice your character level when you gain this feat. Whenever you gain a level thereafter, your Hit Point maximum increases by an additional 2 HP.',
  ],
};
