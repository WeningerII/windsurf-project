...
export const archmage: Monster = {
  ...
  legendaryActions: [
    ...
    },
    {
      ...
      cost: 1,
      description: 'The archmage casts a spell of 1st through 3rd level, using a spell slot as normal. To do so, it must use an action on its turn.',
    },
  ],
  environment: ['tower', 'urban'],
};

export const humanoidsCR11Plus: Monster[] = [
  archmage,
];
