...
export const vampire: Monster = {
  ...
  specialAbilities: [
    {
      ...
      description: 'If the vampire fails a saving throw, it can choose to succeed instead. It can use this trait three times and regains expended uses when it finishes a long rest.',
    },
    {
      name: 'Misty Form',
      description: 'The vampire can use its action to polymorph into a cloud of mist or back into its true form. While in mist form, the vampire can\'t take any actions, speak, or manipulate objects. It is weightless, has a flying speed of 20 feet, can enter a hostile creature\'s space and stop there, and can move through open doors and windows.',
    },
    {
      name: 'Regeneration',
  ...
  actions: [
    {
      name: 'Multiattack',
      description: 'The vampire makes two attacks, only one of which can be a bite attack. It can use Parry in place of one attack.',
    },
    {
      name: 'Unarmed Strike',
      description: 'Melee Weapon Attack: +8 to hit, reach 5 ft., one creature. Hit: 8 (1d8 + 4) bludgeoning damage. Instead of dealing damage, the vampire can grapple the target (escape DC 16).',
    },
    {
      name: 'Bite',
      description: 'Melee Weapon Attack: +8 to hit, reach 5 ft., one willing creature, or a creature that is grappled by the vampire, incapacitated, or restrained. Hit: 8 (1d8 + 4) piercing damage plus 14 (4d6) necrotic damage. The target\'s hit point maximum is reduced by an amount equal to the necrotic damage taken, and the vampire regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if this effect reduces its hit point maximum to 0.',
    },
  ],
  legendaryActions: [
    {
  ...
  actions: [
    {
      ...
      description: 'Melee Spell Attack: +9 to hit, reach 5 ft., one creature. Hit: 10 (3d6) cold damage. The target must succeed on a DC 17 Constitution saving throw or be paralyzed for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.',
    },
  ],
  legendaryActions: [
    {
    ...
    },
    {
      ...
      cost: 2,
      description: 'The lich fixes its gaze on one creature it can see within 10 feet of it. The target must succeed on a DC 17 Wisdom saving throw against this magic or become frightened until the end of its next turn.',
    },
    {
      name: 'Disrupt Life',
      cost: 3,
      description: 'Each non-undead creature within 20 feet of the lich must make a DC 17 Constitution saving throw against this magic, taking 21 (6d6) necrotic damage on a failed save, or half as much on a successful one.',
    },
  ],
  environment: ['tower', 'dungeon'],
};

export const undeadCR11Plus: Monster[] = [
  vampire,
  lich,
];
