...
export const constructArchetype: CharacterClass = {
  ...
  sourceBook: { name: "Mutants & Masterminds Hero's Handbook", page: 1, url: 'https://www.d20herosrd.com/character-creation/archetypes/construct/' },
  hitDie: 'd10',
  ...
  features: [
    {
      level: 1,
      features: [
        { id: 'artificial-being', name: 'Artificial Being', source: 'Construct', description: 'Immunity to biological effects' },
        { id: 'enhanced-durability', name: 'Enhanced Durability', source: 'Construct', description: 'Increased protection and resistance' },
      ],
    },
  ],
  subclassLevel: 1,
