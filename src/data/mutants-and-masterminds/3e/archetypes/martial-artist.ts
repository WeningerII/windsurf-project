...
export const martialArtistArchetype: CharacterClass = {
  ...
  sourceBook: { name: "Mutants & Masterminds Hero's Handbook", page: 1, url: 'https://www.d20herosrd.com/character-creation/archetypes/martial-artist/' },
  hitDie: 'd8',
  ...
  weaponProficiencies: [],
  toolProficiencies: [],
  skillProficiencies: { count: 2, options: ['athletics', 'acrobatics'], label: 'Choose class skills' },
  equipmentChoices: [],
  ...
  features: [
    {
      level: 1,
      features: [
        { id: 'unarmed-mastery', name: 'Unarmed Mastery', source: 'Martial Artist', description: 'Devastating unarmed strikes' },
        { id: 'ki-control', name: 'Ki Control', source: 'Martial Artist', description: 'Channel inner energy for enhanced abilities' },
      ],
    },
  ],
  subclassLevel: 1,
