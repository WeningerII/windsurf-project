...
export const energyControllerArchetype: CharacterClass = {
  ...
  sourceBook: { name: "Mutants & Masterminds Hero's Handbook", page: 1, url: 'https://www.d20herosrd.com/character-creation/archetypes/energy-controller/' },
  hitDie: 'd8',
  ...
  weaponProficiencies: [],
  toolProficiencies: [],
  skillProficiencies: { count: 2, options: ['science', 'perception'], label: 'Choose class skills' },
  equipmentChoices: [],
  ...
  features: [
    {
      level: 1,
      features: [
        { id: 'energy-manipulation', name: 'Energy Manipulation', source: 'Energy Controller', description: 'Control and project various forms of energy' },
        { id: 'energy-immunity', name: 'Energy Immunity', source: 'Energy Controller', description: 'Resist your chosen energy type' },
      ],
    },
  ],
  subclassLevel: 1,
