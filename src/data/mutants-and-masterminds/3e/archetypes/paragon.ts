...
export const paragonArchetype: CharacterClass = {
  ...
  sourceBook: { name: "Mutants & Masterminds Hero's Handbook", page: 1, url: 'https://www.d20herosrd.com/character-creation/archetypes/paragon/' },
  hitDie: 'd10',
  ...
  weaponProficiencies: [],
  toolProficiencies: [],
  skillProficiencies: { count: 3, options: ['athletics', 'perception', 'persuasion'], label: 'Choose class skills' },
  equipmentChoices: [],
  ...
  features: [
    {
      level: 1,
      features: [
        { id: 'super-strength', name: 'Super-Strength', source: 'Paragon', description: 'Incredible strength and physical power' },
        { id: 'flight', name: 'Flight', source: 'Paragon', description: 'Ability to fly' },
        { id: 'invulnerability', name: 'Invulnerability', source: 'Paragon', description: 'Nearly invulnerable to damage' },
      ],
    },
  ],
  subclassLevel: 1,
