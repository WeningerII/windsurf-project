...
export const psychicArchetype: CharacterClass = {
  ...
  sourceBook: { name: "Mutants & Masterminds Hero's Handbook", page: 1, url: 'https://www.d20herosrd.com/character-creation/archetypes/psychic/' },
  hitDie: 'd6',
  ...
  weaponProficiencies: [],
  toolProficiencies: [],
  skillProficiencies: { count: 2, options: ['insight', 'perception'], label: 'Choose class skills' },
  equipmentChoices: [],
  ...
  features: [
    {
      level: 1,
      features: [
        { id: 'telepathy', name: 'Telepathy', source: 'Psychic', description: 'Communicate mind-to-mind with others' },
        { id: 'psychic-blast', name: 'Psychic Blast', source: 'Psychic', description: 'Attack minds directly with psychic force' },
      ],
    },
  ],
  subclassLevel: 1,
