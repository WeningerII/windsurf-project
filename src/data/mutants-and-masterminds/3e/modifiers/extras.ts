...
export const affects_objects: PowerModifier = {
  ...
  flatCost: 1,
  description:
    'This modifier allows effects normally resisted by Fortitude to work on non-living objects.',
...
export const alternate_effect: PowerModifier = {
  ...
  flatCost: 1,
  description:
    "Creates an alternate use for a power that can't be used at the same time as the base effect.",
...
export const area: PowerModifier = {
  ...
  effects: [
    'Burst: radius equal to (rank x 30) feet',
    'Cloud: radius equal to (rank x 15) feet, provides concealment',
    'Cone: cone (rank x 60) feet long',
    'Cylinder: (rank x 30) feet radius, (rank x 30) feet tall',
    'Line: line (rank x 5) feet wide, (rank x 30) feet long',
    'Perception: affects all targets the user can perceive',
    'Shapeable: (rank x 30) 5-foot cubes',
  ],
};
...
export const dimensional: PowerModifier = {
  ...
  effects: [
    'Rank 1: One other dimension',
    'Rank 2: Any of a related group of dimensions',
...
export const impervious: PowerModifier = {
  ...
  effects: [
    'Resistance ignores effects with a rank equal to or less than half the Impervious rank (rounded up).',
  ],
};
...
export const increased_duration: PowerModifier = {
  ...
  effects: [
    'Instant becomes Concentration',
    'Concentration becomes Sustained',
    'Sustained becomes Continuous',
    'Continuous becomes Permanent',
  ],
};
...
export const indirect: PowerModifier = {
  ...
  effects: [
    'Rank 1: Fixed point away from you',
    'Rank 2: Any point away from you, directed toward you',
    'Rank 3: Any point, any direction',
    'Rank 4: Any point, any direction, can change origin point',
  ],
};
...
export const innate: PowerModifier = {
  ...
  flatCost: 1,
  description:
    'An effect with this extra is an innate part of your nature and cannot be Nullified.',
...
export const multiattack: PowerModifier = {
  ...
  costPerRank: 1,
  description:
    'This extra allows an effect to hit multiple targets or hit one target multiple times.',
  effects: [
    'Attack multiple targets at -2 per additional target',
    'Or attack one target with +2 to effect for every 5 points attack exceeds defense (max +5)',
  ],
};
...
export const secondary_effect: PowerModifier = {
  ...
  costPerRank: 1,
  description:
    'An instant effect with this extra affects the target once and then again on the following round.',
...
export const sleep: PowerModifier = {
  ...
  flatCost: 0,
  description:
    'For Affliction powers, changes the third degree to Asleep instead of Incapacitated.',
...
export const subtle: PowerModifier = {
  ...
  effects: [
    'Rank 1: Effect is subtle (DC 20 to notice)',
    'Rank 2: Effect is completely undetectable',
  ],
};
...
export const variable_descriptor: PowerModifier = {
  ...
  effects: [
    'Rank 1: Change between a close group of descriptors (e.g., fire, heat, plasma)',
    'Rank 2: Change between a broad group of descriptors (e.g., any energy type)',
  ],
};
