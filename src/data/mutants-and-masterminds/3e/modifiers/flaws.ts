...
export const activation: PowerModifier = {
  id: 'activation', name: 'Activation', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0, flatCost: -1,
...
export const check_required: PowerModifier = {
  id: 'check-required', name: 'Check Required', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0, flatCost: -1,
...
export const diminished_range: PowerModifier = {
  id: 'diminished-range', name: 'Diminished Range', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0, flatCost: -1,
...
export const distracting: PowerModifier = {
  id: 'distracting', name: 'Distracting', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const fades: PowerModifier = {
  id: 'fades', name: 'Fades', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const feedback: PowerModifier = {
  id: 'feedback', name: 'Feedback', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const grab_based: PowerModifier = {
  id: 'grab-based', name: 'Grab-Based', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const inaccurate: PowerModifier = {
  id: 'inaccurate', name: 'Inaccurate', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const limited: PowerModifier = {
  id: 'limited', name: 'Limited', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const noticeable: PowerModifier = {
  id: 'noticeable', name: 'Noticeable', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0, flatCost: -1,
...
export const permanent: PowerModifier = {
  id: 'permanent', name: 'Permanent', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0,
...
export const quirk: PowerModifier = {
  id: 'quirk', name: 'Quirk', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0, flatCost: -1,
...
export const reduced_range: PowerModifier = {
  id: 'reduced-range', name: 'Reduced Range', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
  description: 'This flaw reduces the range of an effect.',
  effects: ['Perception becomes Ranged (-1)', 'Ranged becomes Close (-1)', 'Close becomes Touch (-1)'],
};

export const removable: PowerModifier = {
  id: 'removable', name: 'Removable', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0, flatCost: -1,
  description: 'An effect with this flaw is tied to a device that can be taken away.',
  effects: ['-1 per 5 points: Removable (requires a standard action to remove)', '-2 per 5 points: Easily Removable (can be removed as a move action or grabbed)'],
};

export const resistible: PowerModifier = {
  id: 'resistible', name: 'Resistible', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const sense_dependent: PowerModifier = {
  id: 'sense-dependent', name: 'Sense-Dependent', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const side_effect: PowerModifier = {
  id: 'side-effect', name: 'Side Effect', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const tiring: PowerModifier = {
  id: 'tiring', name: 'Tiring', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const uncontrolled: PowerModifier = {
  id: 'uncontrolled', name: 'Uncontrolled', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const unreliable: PowerModifier = {
  id: 'unreliable', name: 'Unreliable', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
  description: 'This effect is unreliable.',
  effects: ['Roll d20 before use: on 10 or less, effect fails. Or: 5 uses before requiring hour rest.'],
};

export const concentration: PowerModifier = {
  id: 'concentration', name: 'Concentration', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
  description: 'Maintaining this effect requires concentration.',
  effects: ['Requires concentration to maintain. Broken if you are dazed, stunned, or fail concentration check.'],
};

export const continuous_flaw: PowerModifier = {
  id: 'continuous-flaw', name: 'Continuous', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0,
...
export const delayed: PowerModifier = {
  id: 'delayed', name: 'Delayed', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const diminished: PowerModifier = {
  id: 'diminished', name: 'Diminished', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const exhausting: PowerModifier = {
  id: 'exhausting', name: 'Exhausting', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const full_power: PowerModifier = {
  id: 'full-power', name: 'Full Power', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const increased_duration_flaw: PowerModifier = {
  id: 'increased-duration-flaw', name: 'Increased Duration', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0,
...
export const instant: PowerModifier = {
  id: 'instant', name: 'Instant', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0,
...
export const limited_to_condition: PowerModifier = {
  id: 'limited-to-condition', name: 'Limited to Condition', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const linked_flaw: PowerModifier = {
  id: 'linked-flaw', name: 'Linked', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0,
...
export const mental_flaw: PowerModifier = {
  id: 'mental-flaw', name: 'Mental', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const no_range: PowerModifier = {
  id: 'no-range', name: 'No Range', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const nuisance: PowerModifier = {
  id: 'nuisance', name: 'Nuisance', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0, flatCost: -1,
...
export const objects_only: PowerModifier = {
  id: 'objects-only', name: 'Objects Only', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const proportional: PowerModifier = {
  id: 'proportional', name: 'Proportional', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const quirk_flaw: PowerModifier = {
  id: 'quirk-flaw', name: 'Quirk', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0, flatCost: -1,
...
export const random: PowerModifier = {
  id: 'random', name: 'Random', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const reaction_flaw: PowerModifier = {
  id: 'reaction-flaw', name: 'Reaction', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0,
...
export const uncontrollable: PowerModifier = {
  id: 'uncontrollable', name: 'Uncontrollable', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const unreliable_flaw: PowerModifier = {
  id: 'unreliable-flaw', name: 'Unreliable', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const vulnerable: PowerModifier = {
  id: 'vulnerable', name: 'Vulnerable', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const wall: PowerModifier = {
  id: 'wall', name: 'Wall', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: 0,
...
export const weak_point: PowerModifier = {
  id: 'weak-point', name: 'Weak Point', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const close_range_only: PowerModifier = {
  id: 'close-range-only', name: 'Close Range Only', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const limited_uses: PowerModifier = {
  id: 'limited-uses', name: 'Limited Uses', system: 'mam3e', source: "Hero's Handbook",
  type: 'flaw', costPerRank: -1,
...
export const flaws: PowerModifier[] = [
  activation, check_required, diminished_range, distracting, fades, feedback,
  grab_based, inaccurate, limited, noticeable, permanent, quirk, reduced_range,
  removable, resistible, sense_dependent, side_effect, tiring, uncontrolled, unreliable,
  concentration, continuous_flaw, delayed, diminished, exhausting, full_power,
  increased_duration_flaw, instant, limited_to_condition, linked_flaw, mental_flaw,
  no_range, nuisance, objects_only, proportional, quirk_flaw, random,
  reaction_flaw, uncontrollable, unreliable_flaw, vulnerable, wall, weak_point,
  close_range_only, limited_uses,
];
