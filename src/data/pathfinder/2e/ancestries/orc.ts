...
export const orc: Species = {
  ...
  languages: {
    ...
    choice: {
      count: 1,
      options: ['Draconic', 'Dwarven', 'Giant', 'Gnoll', 'Goblin', 'Jotun', 'Undercommon'],
  ...
  traits: [
    // Do not implement proprietary content without proper licensing
    {
      ...
      name: 'Darkvision',
      source: 'Orc',
      description: 'You can see in darkness and dim light as though it were bright light.',
    },
    // Do not implement proprietary content without proper licensing
    {
      id: 'orc-ferocity',
      ...
      source: 'Orc',
      description:
        'Once per day, when reduced to 0 HP, you remain conscious and can continue fighting.',
    },
    // Do not implement proprietary content without proper licensing
  ],
  ...
  description:
    'Orcs are forged in the fires of violence and conflict, often from the moment they are born. They are fierce warriors with a strong sense of honor.',
