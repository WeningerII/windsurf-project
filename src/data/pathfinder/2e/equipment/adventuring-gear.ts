...
export const backpack: Item = {
  ...
  description: 'A leather pack for carrying equipment.', source: 'Core Rulebook', requiresAttunement: false,
};

export const bedroll: Item = {
  id: 'bedroll', name: 'Bedroll', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'cp' },
  description: 'A simple bedroll for sleeping.', source: 'Core Rulebook', requiresAttunement: false,
};

export const rope: Item = {
  id: 'rope', name: 'Rope (50 ft.)', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 5, currency: 'sp' },
  description: 'Hemp rope, 50 feet long.', source: 'Core Rulebook', requiresAttunement: false,
};

export const torch: Item = {
  id: 'torch', name: 'Torch', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'cp' },
  description: 'A wooden torch that burns for 1 hour.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const rations: Item = {
  ...
  description: 'A week of preserved food.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const waterskin: Item = {
  ...
  description: 'A leather pouch for water.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const thievesTools: Item = {
  ...
  description: 'Lock picks and tools for disabling devices.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const healersTools: Item = {
  ...
  description: 'Medical supplies for treating wounds.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const religiousSymbol: Item = {
  ...
  description: 'A symbol of your deity.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const mirror: Item = {
  ...
  description: 'A small steel mirror.', source: 'Core Rulebook', requiresAttunement: false,
};

export const pouch: Item = {
  id: 'pouch', name: 'Pouch', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 5, currency: 'cp' },
  description: 'A belt pouch for small items.', source: 'Core Rulebook', requiresAttunement: false,
};

export const sack: Item = {
  id: 'sack', name: 'Sack', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'cp' },
  description: 'A simple cloth sack.', source: 'Core Rulebook', requiresAttunement: false,
};

export const soap: Item = {
  id: 'soap', name: 'Soap', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 2, currency: 'cp' },
  description: 'A bar of soap.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const spellbook: Item = {
  ...
  description: 'A blank spellbook.', source: 'Core Rulebook', requiresAttunement: false,
};

export const ink: Item = {
  id: 'ink', name: 'Ink (1 oz vial)', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'gp' },
  description: 'A vial of black ink.', source: 'Core Rulebook', requiresAttunement: false,
};

export const pen: Item = {
  id: 'pen', name: 'Ink Pen', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 2, currency: 'cp' },
  description: 'A writing implement.', source: 'Core Rulebook', requiresAttunement: false,
};

export const parchment: Item = {
  id: 'parchment', name: 'Parchment (sheet)', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'sp' },
  description: 'A sheet of parchment.', source: 'Core Rulebook', requiresAttunement: false,
};

export const sealing_wax: Item = {
  id: 'sealing-wax', name: 'Sealing Wax', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'sp' },
  description: 'Wax for sealing letters.', source: 'Core Rulebook', requiresAttunement: false,
};

export const vial: Item = {
  id: 'vial', name: 'Vial', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'gp' },
  description: 'A small glass vial.', source: 'Core Rulebook', requiresAttunement: false,
};

export const flask: Item = {
  id: 'flask', name: 'Flask', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 3, currency: 'cp' },
  description: 'A leather or metal flask.', source: 'Core Rulebook', requiresAttunement: false,
};

export const jug: Item = {
  id: 'jug', name: 'Jug', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 3, currency: 'cp' },
  description: 'A ceramic jug.', source: 'Core Rulebook', requiresAttunement: false,
};

export const bucket: Item = {
  id: 'bucket', name: 'Bucket', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 5, currency: 'cp' },
  description: 'A wooden bucket.', source: 'Core Rulebook', requiresAttunement: false,
};

export const chest: Item = {
  id: 'chest', name: 'Chest', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 5, cost: { amount: 2, currency: 'gp' },
  description: 'A wooden chest for storage.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const ladder: Item = {
  ...
  description: 'A wooden ladder.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const ironChain: Item = {
  ...
  description: 'Iron chain.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const manacles: Item = {
  ...
  description: 'Iron manacles with a key.', source: 'Core Rulebook', requiresAttunement: false,
};

export const lock: Item = {
  id: 'lock', name: 'Lock', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 10, currency: 'gp' },
  description: 'A padlock with a key.', source: 'Core Rulebook', requiresAttunement: false,
};

export const blanket: Item = {
  id: 'blanket', name: 'Blanket', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 5, currency: 'sp' },
  description: 'A wool blanket.', source: 'Core Rulebook', requiresAttunement: false,
};

export const candle: Item = {
  id: 'candle', name: 'Candle', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'cp' },
  description: 'A wax candle.', source: 'Core Rulebook', requiresAttunement: false,
};

export const tinderbox: Item = {
  id: 'tinderbox', name: 'Tinderbox', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 5, currency: 'sp' },
  description: 'Flint and steel for starting fires.', source: 'Core Rulebook', requiresAttunement: false,
};

export const bell: Item = {
  id: 'bell', name: 'Bell', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'gp' },
  description: 'A small bell.', source: 'Core Rulebook', requiresAttunement: false,
};

export const horn: Item = {
  id: 'horn', name: 'Horn', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 3, currency: 'sp' },
  description: 'A signaling horn.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const hourglass: Item = {
  ...
  description: 'A glass time-keeping device.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const magnifying_glass: Item = {
  ...
  description: 'A lens for examining details.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const spyglass: Item = {
  ...
  description: 'A telescope for seeing distant objects.', source: 'Core Rulebook', requiresAttunement: false,
};

export const compass: Item = {
  id: 'compass', name: 'Compass', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 10, currency: 'gp' },
  description: 'A navigational compass.', source: 'Core Rulebook', requiresAttunement: false,
};

export const fishing_tackle: Item = {
  id: 'fishing-tackle', name: 'Fishing Tackle', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 1, currency: 'gp' },
  description: 'Hook, line, and tackle.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const net_fishing: Item = {
  ...
  description: 'A fishing net.', source: 'Core Rulebook', requiresAttunement: false,
};

export const trap: Item = {
  id: 'trap', name: 'Trap (hunting)', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 3, cost: { amount: 5, currency: 'gp' },
  description: 'A mechanical trap for hunting.', source: 'Core Rulebook', requiresAttunement: false,
};

export const whistle: Item = {
  id: 'whistle', name: 'Whistle', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 5, currency: 'cp' },
  description: 'A signal whistle.', source: 'Core Rulebook', requiresAttunement: false,
};

export const basket: Item = {
  id: 'basket', name: 'Basket', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 4, currency: 'sp' },
  description: 'A woven basket.', source: 'Core Rulebook', requiresAttunement: false,
};

export const bottle: Item = {
  id: 'bottle', name: 'Bottle (glass)', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 2, currency: 'gp' },
  description: 'A glass bottle.', source: 'Core Rulebook', requiresAttunement: false,
};

export const scrollCase: Item = {
  id: 'scroll-case', name: 'Map/Scroll Case', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'gp' },
  description: 'A leather tube for maps.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const sledgehammer: Item = {
  ...
  description: 'A heavy hammer for breaking.', source: 'Core Rulebook', requiresAttunement: false,
};

export const saw: Item = {
  id: 'saw', name: 'Saw', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 4, currency: 'sp' },
  description: 'A woodcutting saw.', source: 'Core Rulebook', requiresAttunement: false,
};

export const chisel: Item = {
  id: 'chisel', name: 'Chisel', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 5, currency: 'sp' },
  description: 'A metal chisel.', source: 'Core Rulebook', requiresAttunement: false,
};

export const file: Item = {
  id: 'file', name: 'File', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 5, currency: 'sp' },
  description: 'A metal file.', source: 'Core Rulebook', requiresAttunement: false,
};

export const tongs: Item = {
  id: 'tongs', name: 'Tongs', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 5, currency: 'sp' },
  description: 'Metal tongs for handling hot items.', source: 'Core Rulebook', requiresAttunement: false,
};

export const block_tackle: Item = {
  id: 'block-tackle', name: 'Block and Tackle', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 2, cost: { amount: 5, currency: 'gp' },
  description: 'Pulley system for lifting.', source: 'Core Rulebook', requiresAttunement: false,
};

export const caltrops: Item = {
  id: 'caltrops', name: 'Caltrops', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 1, currency: 'gp' },
  description: 'Spiked metal pieces.', source: 'Core Rulebook', requiresAttunement: false,
};

export const marbles: Item = {
  id: 'marbles', name: 'Marbles', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 1, currency: 'sp' },
  description: 'Glass marbles.', source: 'Core Rulebook', requiresAttunement: false,
};

export const ball_bearings: Item = {
  id: 'ball-bearings', name: 'Ball Bearings', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 1, currency: 'gp' },
  description: 'Metal ball bearings.', source: 'Core Rulebook', requiresAttunement: false,
};

export const dice: Item = {
  id: 'dice', name: 'Dice Set', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 1, currency: 'sp' },
  description: 'Gaming dice.', source: 'Core Rulebook', requiresAttunement: false,
};

export const playing_cards: Item = {
  id: 'playing-cards', name: 'Playing Cards', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 0, cost: { amount: 5, currency: 'sp' },
  description: 'A deck of playing cards.', source: 'Core Rulebook', requiresAttunement: false,
};

export const musical_instrument: Item = {
  id: 'musical-instrument', name: 'Musical Instrument', system: 'pf2e', type: 'gear',
  rarity: 'common', weight: 1, cost: { amount: 5, currency: 'gp' },
  description: 'A common instrument.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const disguise_kit: Item = {
  ...
  description: 'Cosmetics and props for disguises.', source: 'Core Rulebook', requiresAttunement: false,
};

export const artisan_tools: Item = {
  id: 'artisan-tools', name: "Artisan's Tools", system: 'pf2e', type: 'tool',
  rarity: 'common', weight: 2, cost: { amount: 5, currency: 'gp' },
  description: 'Tools for a specific craft.', source: 'Core Rulebook', requiresAttunement: false,
};

export const alchemist_tools: Item = {
  id: 'alchemist-tools', name: "Alchemist's Tools", system: 'pf2e', type: 'tool',
  rarity: 'common', weight: 2, cost: { amount: 5, currency: 'gp' },
  description: 'Equipment for alchemy.', source: 'Core Rulebook', requiresAttunement: false,
};

export const herbalism_kit: Item = {
  id: 'herbalism-kit', name: 'Herbalism Kit', system: 'pf2e', type: 'tool',
  rarity: 'common', weight: 1, cost: { amount: 5, currency: 'gp' },
  description: 'Tools for identifying and preparing herbs.', source: 'Core Rulebook', requiresAttunement: false,
};
