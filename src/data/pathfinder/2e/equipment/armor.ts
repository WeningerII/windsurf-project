...
export const padded: Armor = {
  ...
  description: 'Light padded armor.', requiresAttunement: false,
};
...
export const leather: Armor = {
  ...
  description: 'Basic leather armor.', requiresAttunement: false,
};
...
export const studdedLeather: Armor = {
  ...
  description: 'Leather reinforced with studs.', requiresAttunement: false,
};
...
export const hide: Armor = {
  ...
  description: 'Thick animal hides.', requiresAttunement: false,
};
...
export const scaleMail: Armor = {
  ...
  description: 'Overlapping metal scales.', requiresAttunement: false,
};
...
export const chainmail: Armor = {
  ...
  description: 'Full chainmail suit.', requiresAttunement: false,
};
...
export const splintMail: Armor = {
  ...
  description: 'Vertical strips of metal.', requiresAttunement: false,
};
...
export const halfPlate: Armor = {
  ...
  description: 'Partial plate coverage.', requiresAttunement: false,
};
...
export const fullPlate: Armor = {
  ...
  description: 'Complete suit of plate armor.', requiresAttunement: false,
};
...
export const buckler: Shield = {
  ...
  description: 'A small, light shield.', requiresAttunement: false,
};
...
export const woodenShield: Shield = {
  ...
  description: 'A sturdy wooden shield.', requiresAttunement: false,
};
...
export const steelShield: Shield = {
  ...
  description: 'A steel shield.', requiresAttunement: false,
};
...
export const towerShield: Shield = {
  ...
  description: 'A large shield providing cover.', requiresAttunement: false,
};
...
export const explorerClothing: Armor = {
  ...
  description: 'Durable clothing for adventurers.', requiresAttunement: false,
};
...
export const bandedMail: Armor = {
  ...
  description: 'Overlapping metal bands.', requiresAttunement: false,
};
...
export const ringMail: Armor = {
  ...
  weight: 8, cost: { amount: 10, currency: 'gp' },
  description: 'Armor made of interlocking rings.', requiresAttunement: false,
};
...
export const fieldPlate: Armor = {
  ...
  description: 'Battle-ready plate armor.', requiresAttunement: false,
};
...
export const armoredCoat: Armor = {
  ...
  description: 'A reinforced coat providing protection.', requiresAttunement: false,
};
