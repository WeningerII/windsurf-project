...
export const hide: Armor = {
  ...
  weight: 4,
  cost: { amount: 2, currency: 'gp' },
  description: 'Thick animal hides.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const chainmail: Armor = {
  ...
  description: 'Full chainmail suit.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const breastplate: Armor = {
  ...
  description: 'A fitted metal chestplate.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const splintMail: Armor = {
  ...
  stealthDisadvantage: true,
  weight: 8,
  cost: { amount: 13, currency: 'gp' },
  description: 'Vertical strips of metal.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const fullPlate: Armor = {
  ...
  description: 'Complete suit of plate armor.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const towerShield: Shield = {
  ...
  description: 'A large shield providing cover.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const explorerClothing: Armor = {
  ...
  description: 'Durable clothing for adventurers.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
