...
export const resilientRune: Item = {
  ...
  description:
    'Resilient armor grants a +1 item bonus to saving throws. This is in addition to any bonuses the armor provides to AC.',
...
export const fortification: Item = {
  ...
  description:
    "Armor with this property rune has a chance to turn critical hits into normal hits. When you're critically hit, the attacker must roll a DC 11 flat check. On a failure, the critical hit becomes a normal hit.",
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const greaterFortification: Item = {
  ...
  description:
    'Greater fortification has a DC 14 flat check to turn critical hits into normal hits.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const energyResistant: Item = {
  ...
  description:
    'Choose an energy type (acid, cold, electricity, fire, or sonic). The armor grants resistance 5 to that energy type. You can activate the armor to increase the resistance to 10 for 1 minute.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const greaterEnergyResistant: Item = {
  ...
  description:
    'The armor grants resistance 10 to the chosen energy type. You can activate it to increase the resistance to 15 for 1 minute.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const slick: Item = {
  ...
  description:
    'Slick armor is coated in a frictionless coating. You gain a +1 item bonus to Acrobatics checks to Escape and to your Reflex DC against checks to Grapple you.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const shadow: Item = {
  ...
  description:
    'Shadow armor seems to absorb light. You gain a +1 item bonus to Stealth checks while wearing the armor.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const greaterShadow: Item = {
  ...
  description:
    'Greater shadow armor grants a +2 item bonus to Stealth checks. You can activate the armor to become invisible for 1 round.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const glamered: Item = {
  ...
  description:
    "You can change the appearance of glamered armor to appear as any other type of clothing or armor. This doesn't change the armor's statistics.",
  source: 'Core Rulebook',
  requiresAttunement: false,
};
