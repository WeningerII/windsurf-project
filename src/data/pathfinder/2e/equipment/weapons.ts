...
export const hatchet: Weapon = {
  ...
  description: 'A small axe used in close combat or thrown.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const longspear: Weapon = {
  ...
  description: 'A very long thrusting spear, wielded with two hands.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const net: Weapon = {
  ...
  weight: 1,
  cost: { amount: 1, currency: 'gp' },
  description: 'A net that, roped, lets you Grapple a creature up to 10 feet away.',
...
export const orcNecksplitter: Weapon = {
  id: 'orc-necksplitter',
  ...
  weight: 1,
  cost: { amount: 2, currency: 'gp' },
  description: 'A single-bladed bearded axe with a jagged blade.',
  source: 'Core Rulebook',
  requiresAttunement: false,
};
...
export const earthbreaker: Weapon = {
  ...
  description: 'A wedge-headed hammer that tears through shields and armor.',
  source: 'Pathfinder 2e Treasure Vault',
  requiresAttunement: false,
};
...
export const wakizashi: Weapon = {
  ...
  weight: 0,
  cost: { amount: 1, currency: 'gp' },
  description: 'A short single-edged sword carried alongside a katana.',
  source: "Pathfinder 2e Advanced Player's Guide",
  requiresAttunement: false,
};
...
export const bola: Weapon = {
  ...
  weight: 0,
  cost: { amount: 5, currency: 'sp' },
  description: 'Weights on long cords that bludgeon or entangle the legs.',
  source: "Pathfinder 2e Advanced Player's Guide",
  requiresAttunement: false,
};
...
export const chakram: Weapon = {
  ...
  weight: 0,
  cost: { amount: 5, currency: 'sp' },
  description: 'An open-centered metal discus with a sharpened edge.',
...
export const boomerang: Weapon = {
  ...
  weight: 0,
  cost: { amount: 2, currency: 'sp' },
  description: 'A carved wooden curve that returns after a successful throw.',
  source: 'Pathfinder 2e Treasure Vault',
  requiresAttunement: false,
};
...
export const atlatl: Weapon = {
  ...
  weight: 1,
  cost: { amount: 2, currency: 'sp' },
  description: 'A shaped lever that hurls darts farther and faster.',
  source: 'Pathfinder 2e Treasure Vault',
  requiresAttunement: false,
};
