...
export const club: Weapon = {
  ...
  description: 'A simple wooden club.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const dagger: Weapon = {
  ...
  description: 'A small blade for melee or ranged attacks.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const mace: Weapon = {
  ...
  description: 'A metal-headed club.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const quarterstaff: Weapon = {
  ...
  description: 'A wooden staff, two-handed for 1d8.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const spear: Weapon = {
  ...
  description: 'A simple piercing polearm.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const crossbow: Weapon = {
  ...
  description: 'A mechanical bow that fires bolts.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const javelin: Weapon = {
  ...
  description: 'A throwing spear.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const sling: Weapon = {
  ...
  description: 'A simple ranged weapon.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const battleaxe: Weapon = {
  ...
  properties: [], weight: 2, cost: { amount: 1, currency: 'gp' },
  description: 'A heavy axe for battle.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const greatsword: Weapon = {
  ...
  description: 'A massive two-handed sword.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const longsword: Weapon = {
  ...
  description: 'A versatile one-handed sword.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const rapier: Weapon = {
  ...
  description: 'A thrusting sword for precise attacks.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const shortsword: Weapon = {
  ...
  description: 'A short blade for quick attacks.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const warhammer: Weapon = {
  ...
  properties: [], weight: 2, cost: { amount: 1, currency: 'gp' },
  description: 'A hammer for combat.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const longbow: Weapon = {
  ...
  description: 'A tall bow for long-range shots.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const shortbow: Weapon = {
  ...
  description: 'A shorter bow for quicker shots.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const sickle: Weapon = {
  ...
  description: 'A farming tool adapted for combat.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const handaxe: Weapon = {
  ...
  description: 'A light throwing axe.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const lightHammer: Weapon = {
  ...
  description: 'A small hammer for throwing.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const morningstar: Weapon = {
  ...
  description: 'A spiked club.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const dart: Weapon = {
  ...
  description: 'A small throwing projectile.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const flail: Weapon = {
  ...
  rarity: 'common', damage: { count: 1, die: 'd8', notation: '1d8' }, damageType: 'bludgeoning',
  properties: [], weight: 2, cost: { amount: 1, currency: 'gp' },
  description: 'A spiked ball on a chain.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const glaive: Weapon = {
  ...
  description: 'A pole with a blade.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const greataxe: Weapon = {
  ...
  rarity: 'common', damage: { count: 1, die: 'd12', notation: '1d12' }, damageType: 'slashing',
  properties: ['two-handed'], weight: 4, cost: { amount: 2, currency: 'gp' },
  description: 'A massive two-handed axe.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const greatclub: Weapon = {
  ...
  description: 'A large heavy club.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const halberd: Weapon = {
  ...
  description: 'An axe blade on a pole.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const lance: Weapon = {
  ...
  description: 'A cavalry weapon.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const maul: Weapon = {
  ...
  description: 'A massive hammer.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const pick: Weapon = {
  ...
  rarity: 'common', damage: { count: 1, die: 'd8', notation: '1d8' }, damageType: 'piercing',
  properties: [], weight: 3, cost: { amount: 8, currency: 'sp' },
  description: 'A mining tool weaponized.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const pike: Weapon = {
  ...
  description: 'A long infantry spear.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const scimitar: Weapon = {
  ...
  description: 'A curved blade.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const trident: Weapon = {
  ...
  description: 'A three-pronged spear.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const warPick: Weapon = {
  ...
  description: 'A heavy piercing weapon.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const whip: Weapon = {
  ...
  description: 'A flexible striking weapon.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const blowgun: Weapon = {
  ...
  description: 'A tube for firing darts.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const handCrossbow: Weapon = {
  ...
  description: 'A small crossbow.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const heavyCrossbow: Weapon = {
  ...
  description: 'A powerful crossbow.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const net: Weapon = {
  ...
  description: 'A net for entangling (restrains on hit).', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const compositeShortbow: Weapon = {
  ...
  description: 'A composite bow for added power.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const compositeLongbow: Weapon = {
  ...
  description: 'A composite longbow.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const falchion: Weapon = {
  ...
  description: 'A curved single-edged sword.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const ranseur: Weapon = {
  ...
  description: 'A polearm with a spearhead.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const scythe: Weapon = {
  ...
  description: 'A curved blade on a long handle.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const spikedChain: Weapon = {
  ...
  description: 'A length of chain with spikes.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const starknife: Weapon = {
  ...
  description: 'A four-pointed throwing blade.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const bastardSword: Weapon = {
  ...
  description: 'A hand-and-a-half sword.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const dwarvenWaraxe: Weapon = {
  ...
  description: 'A heavy dwarven axe.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const gnomeHookedHammer: Weapon = {
  ...
  description: 'A hammer with a hook.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const orcDoubleAxe: Weapon = {
  ...
  description: 'A double-headed orcish axe.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const kama: Weapon = {
  ...
  description: 'A sickle-like weapon.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const nunchaku: Weapon = {
  ...
  rarity: 'common', damage: { count: 1, die: 'd6', notation: '1d6' }, damageType: 'bludgeoning',
  properties: ['light'], weight: 1, cost: { amount: 2, currency: 'sp' },
  description: 'Two sticks connected by chain.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const sai: Weapon = {
  ...
  description: 'A pronged truncheon.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const siangham: Weapon = {
  ...
  description: 'A pointed weapon for monks.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const dogslicer: Weapon = {
  ...
  properties: ['light'], weight: 1, cost: { amount: 1, currency: 'sp' },
  description: 'A crude goblin blade.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const horsechopper: Weapon = {
  ...
  description: 'A goblin polearm.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const kukri: Weapon = {
  ...
  description: 'A curved dagger.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const cestus: Weapon = {
  ...
  description: 'A studded glove.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const gauntlet: Weapon = {
  ...
  rarity: 'common', damage: { count: 1, die: 'd4', notation: '1d4' }, damageType: 'bludgeoning',
  properties: ['light'], weight: 1, cost: { amount: 5, currency: 'sp' },
  description: 'An armored glove.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const spikedGauntlet: Weapon = {
  ...
  rarity: 'common', damage: { count: 1, die: 'd4', notation: '1d4' }, damageType: 'piercing',
  properties: ['light'], weight: 1, cost: { amount: 5, currency: 'sp' },
  description: 'A gauntlet with spikes.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const unarmedStrike: Weapon = {
  ...
  description: 'A punch or kick.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const elvenCurveBlade: Weapon = {
  ...
  description: 'A curved elven blade.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const earthBreaker: Weapon = {
  ...
  description: 'A massive two-handed hammer.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const katana: Weapon = {
  ...
  description: 'A curved single-edged blade.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const wakizashi: Weapon = {
  ...
  description: 'A short companion sword.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const chain: Weapon = {
  ...
  description: 'A length of chain.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const bola: Weapon = {
  ...
  description: 'Weighted cords for entangling.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const chakram: Weapon = {
  ...
  description: 'A circular throwing blade.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const shuriken: Weapon = {
  ...
  description: 'Small throwing stars.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const throwingAxe: Weapon = {
  ...
  description: 'An axe balanced for throwing.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const boomerang: Weapon = {
  ...
  description: 'A curved throwing stick.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const atlatl: Weapon = {
  ...
  description: 'A spear-throwing device.', source: 'Core Rulebook', requiresAttunement: false,
};
...
export const boar: Weapon = {
  ...
  description: 'A spear for hunting boar.', source: 'Core Rulebook', requiresAttunement: false,
};
