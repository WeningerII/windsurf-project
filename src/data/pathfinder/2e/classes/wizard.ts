...
export const wizard: CharacterClass = {
  ...
  sourceBook: {
    ...
    page: 202,
    url: 'https://2e.aonprd.com/Classes.aspx?ID=12',
  },
  hitDie: 'd6',
  primaryAbility: ['int'],
  ...
  // 'choose 2 from a 1-item list'. Fixed training (arcana) is granted by the class template.
  skillProficiencies: {
    count: 2,
    options: [
      'acrobatics',
    ...
    label: 'Trained in Arcana and 2 + Int skills',
  },
  equipmentChoices: [],
      ...
      features: [
        {
          ...
          source: 'Wizard 1',
          description:
            'Choose a school of magic or become a universalist. Your school grants you focus spells and abilities.',
        },
        {
          id: 'arcane-bond',
          name: 'Arcane Bond',
          source: 'Wizard 1',
          description: 'You forge a bond with an item, typically a staff or spellbook.',
        },
        {
          id: 'arcane-thesis',
          name: 'Arcane Thesis',
          source: 'Wizard 1',
          description: 'Your thesis represents your approach to arcane magic.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Wizard 7',
          description:
            'Your proficiency ranks for arcane spell attacks and DCs increase to expert.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Wizard 15',
          description:
            'Your proficiency ranks for arcane spell attacks and DCs increase to master.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Wizard 19',
          description:
            'Your proficiency ranks for arcane spell attacks and DCs increase to legendary.',
        },
      ],
    },
  ],
  ...
  subclasses: [
          ...
          features: [
            {
              ...
              source: 'Abjuration 1',
              description:
                'You gain the protective ward school spell and can add abjuration spells to your spellbook more easily.',
            },
          ],
        },
        {
          ...
          features: [
            {
              ...
              source: 'Abjuration 8',
              description:
                'When your protective ward absorbs energy damage, you can convert it into temporary Hit Points.',
            },
          ],
        },
      ],
    },
    {
      ...
      parentClassId: 'wizard',
      description:
        'You pierce the veil of time and space, gaining knowledge of things yet to come.',
      features: [
        {
          level: 1,
          features: [
            {
              ...
              source: 'Divination 1',
              description:
                "You gain the diviner's sight school spell and can add divination spells to your spellbook more easily.",
            },
          ],
        },
        {
          ...
          features: [
            {
              ...
              source: 'Divination 6',
              description:
                'You gain a +1 circumstance bonus to Perception checks and initiative rolls.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Evocation 1',
              description:
                'You gain the force bolt school spell and can add evocation spells to your spellbook more easily.',
            },
          ],
        },
        {
          ...
          features: [
            {
              ...
              source: 'Evocation 6',
              description:
                'You can change the damage type of your evocation spells that deal energy damage.',
            },
          ],
        },
        {
          ...
          features: [
            {
              ...
              source: 'Evocation 8',
              description:
                'Your evocation spells ignore an amount of resistance equal to half your level.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Illusion 1',
              description:
                'You gain the warped terrain school spell and can add illusion spells to your spellbook more easily.',
            },
          ],
        },
        {
          ...
          features: [
            {
              ...
              source: 'Illusion 8',
              description: 'You can become invisible as a free action once per day.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Transmutation 1',
              description:
                'You gain the telekinetic hand school spell and can add transmutation spells to your spellbook more easily.',
            },
          ],
        },
        {
          ...
          features: [
            {
              id: 'transmutation-mastery',
              name: 'Transmutation Mastery',
              source: 'Transmutation 6',
              description: 'You gain a +1 status bonus to transmutation spell DCs.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Conjuration 1',
              description:
                'You gain the mage hand school spell and can add conjuration spells to your spellbook more easily.',
            },
          ],
        },
        {
          ...
          features: [
            {
              id: 'summoning-mastery',
              name: 'Summoning Mastery',
              source: 'Conjuration 8',
              description:
                'Your summoned creatures gain a +1 status bonus to attack and damage rolls.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Necromancy 1',
              description:
                'You gain the chill touch school spell and can add necromancy spells to your spellbook more easily.',
            },
          ],
        },
        {
          ...
          features: [
            {
              ...
              name: 'Undead Mastery',
              source: 'Necromancy 6',
              description: 'Your undead minions gain additional Hit Points equal to your level.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Enchantment 1',
              description:
                'You gain the charm school spell and can add enchantment spells to your spellbook more easily.',
            },
          ],
        },
        {
          ...
          features: [
            {
              id: 'charm-mastery',
              name: 'Charm Mastery',
              source: 'Enchantment 8',
              description:
                'When you cast an enchantment spell, you gain a +1 status bonus to the spell DC.',
            },
          ],
        },
      ],
  ...
  description:
    'You are an eternal student of the arcane secrets of the universe, using your mastery of magic to cast powerful spells.',
  displayMetadata: {
    icon: 'book',
    color: '#4169E1',
