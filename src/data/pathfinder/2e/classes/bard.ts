...
export const bard: CharacterClass = {
  ...
  sourceBook: {
    ...
    page: 96,
    url: 'https://2e.aonprd.com/Classes.aspx?ID=3',
  },
  hitDie: 'd8',
  primaryAbility: ['cha'],
      ...
      features: [
        {
          ...
          source: 'Bard 1',
          description:
            'Choose a muse: Enigma, Maestro, or Polymath. Your muse influences your spells and abilities.',
        },
        {
          id: 'composition-spells',
          name: 'Composition Spells',
          source: 'Bard 1',
          description: 'You can use your performances to cast unique composition spells.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Bard 3',
          description: 'You can heighten certain spells freely.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Bard 7',
          description:
            'Your proficiency ranks for occult spell attacks and DCs increase to expert.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Bard 13',
          description: 'Your proficiency rank for light armor increases to expert.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Bard 15',
          description:
            'Your proficiency ranks for occult spell attacks and DCs increase to master.',
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          source: 'Bard 19',
          description:
            'Your proficiency ranks for occult spell attacks and DCs increase to legendary.',
        },
      ],
    },
  ],
  ...
  subclasses: [
          ...
          features: [
            {
              id: 'bardic-lore',
              name: 'Bardic Lore',
              source: 'Enigma Muse 1',
              description:
                'Your muse has taught you unusual lore. You gain the Bardic Lore feat and become trained in Occultism and a Lore skill of your choice.',
            },
          ],
        },
        {
          ...
          features: [
            {
              id: 'enigma-scholar',
              name: 'Enigma Scholar',
              source: 'Enigma Muse 4',
              description:
                'Your pursuit of knowledge has led you to master various skills. You gain expert proficiency in Occultism.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Maestro Muse 1',
              description:
                'You gain the lingering composition focus spell. You can extend the duration of your composition spells.',
            },
          ],
        },
        {
          ...
          features: [
            {
              id: 'maestro-performance',
              name: 'Maestro Performance',
              source: 'Maestro Muse 2',
              description:
                'Your performances are legendary. You gain expert proficiency in Performance.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Polymath Muse 1',
              description:
                'You can use Performance instead of Diplomacy, Deception, or Intimidation for certain checks.',
            },
          ],
        },
        {
          ...
          features: [
            {
              ...
              source: 'Polymath Muse 2',
              description:
                'You can add spells from other traditions to your repertoire by using a special polymath ability.',
            },
          ],
        },
      ],
          ...
          features: [
            {
              ...
              source: 'Lore Muse 1',
              description:
                'You gain additional skill training and can Recall Knowledge more effectively. You become trained in two additional skills of your choice.',
            },
          ],
        },
        {
          ...
          features: [
            {
              id: 'scholarly-insight',
              name: 'Scholarly Insight',
              source: 'Lore Muse 2',
              description: 'When you Recall Knowledge, you gain a +1 status bonus to the check.',
            },
          ],
        },
      ],
      ...
      features: [
        {
          ...
          features: [
            {
              id: 'occult-connection',
              name: 'Occult Connection',
              source: 'Occult Muse 1',
              description:
                'You gain additional occult spells and can sense supernatural presences. You become trained in Occultism.',
            },
          ],
        },
        {
          ...
          features: [
            {
              ...
              source: 'Occult Muse 2',
              description:
                'You gain a +1 status bonus to Perception checks to sense supernatural creatures.',
            },
          ],
        },
      ],
    },
    {
      ...
      parentClassId: 'bard',
      description:
        'Your muse speaks through whispers and shadows, granting you secrets and deceptions.',
      features: [
        {
          level: 1,
          features: [
            {
              ...
              source: 'Whispers Muse 1',
              description:
                'You gain the whispered secrets focus spell. You can communicate with allies telepathically.',
            },
          ],
        },
        {
