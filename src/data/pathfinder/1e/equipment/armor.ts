...
export const leather: Armor = {
  ...
  description: 'Leather armor covering the torso.',
  requiresAttunement: false,
};
...
export const bandedMail: Armor = {
  ...
  description: 'Overlapping strips of metal over chain.',
  requiresAttunement: false,
};
...
export const lightShield: Shield = {
  ...
  armorClassBonus: 1,
  weight: 6,
  cost: { amount: 9, currency: 'gp' },
  description: 'A light wooden or steel shield.',
  requiresAttunement: false,
};
...
export const heavyShield: Shield = {
  ...
  description: 'A heavy wooden or steel shield.',
  requiresAttunement: false,
};
...
export const towerShield: Shield = {
  ...
  description: 'A massive shield providing cover.',
  requiresAttunement: false,
};
