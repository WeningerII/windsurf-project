...
export const pf1eSrdMagicItems: MagicItem[] = [
  ...
  {
    id: 'belt-of-incredible-dexterity',
  ...
  {
    id: 'belt-of-mighty-constitution',
  ...
  {
    id: 'belt-of-physical-perfection',
  ...
  {
    id: 'codex-of-the-infinite-planes',
  ...
  {
    id: 'crystal-hypnosis-ball',
    name: 'Crystal Hypnosis Ball',
    system: 'pf1e',
    source: 'Core Rulebook',
    type: 'magic-item',
    rarity: 'uncommon',
  ...
  {
    id: 'headband-of-alluring-charisma',
  ...
  {
    id: 'headband-of-inspired-wisdom',
  ...
  {
    id: 'headband-of-mental-superiority',
  ...
  {
    id: 'headband-of-vast-intelligence',
  ...
  {
    id: 'longsword-cold-iron-masterwork',
    name: 'Longsword, Cold Iron Masterwork',
    system: 'pf1e',
    source: 'Core Rulebook',
    type: 'magic-item',
    rarity: 'uncommon',
  ...
  },
  {
    ...
    description:
      'This +3 heavy mace must be coated in blood every day, or else its bonus fades away until the mace is coated again. The character using this mace must make a DC 13 Will save every day it is within his possession or become chaotic evil. Magic Items +3 heavy mace',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  },
  {
    ...
    description:
      "A necklace of strangulation appears to be a wondrous piece of magical jewelry. When placed on the neck, the necklace immediately tightens, dealing 6 points of damage per round. It cannot be removed by any means short of a limited wish, wish, or miracle and remains clasped around the victim's throat even after his death. Only when he has decayed to a dry skeleton (after approximately 1 month) does the necklace loosen, ready for another victim. Magic Items necklace of adaptation, necklace of fireballs, periapt of health, periapt of proof against poison, periapt of wound closure",
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'This net provides a +3 bonus on attack rolls but can only be used underwater. Underwater, it can be commanded to shoot forth up to 30 feet to trap a creature. If thrown on land, it changes course to target the creature that threw it. Magic Items +3 net',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  },
  {
    ...
    description:
      'This potion has lost its beneficial abilities and become a potent poison. This poison deals 1d3 Constitution damage per round for 6 rounds. A poisoned creature can make a DC 14 Fortitude save each round to negate the damage and end the affliction. Magic Items any potion',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  },
  {
    ...
    description: 'As the minor ring of spell storing, except it holds up to 5 levels of spells.',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    id: 'ring-of-spell-storing-major',
  ...
  {
    id: 'ring-of-spell-storing-minor',
  ...
  },
  {
    ...
    description: 'This ring allows the caster to use the spell telekinesis on command.',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  },
  {
    ...
    description:
      "This valuable garment appears to be a normal robe until it is put on. Its wearer is able to see in all directions at the same moment due to scores of visible, magical eye-like patterns that adorn the robe. She also gains 120-foot darkvision. The robe of eyes sees all forms of invisible or ethereal creatures or objects within 120 feet. The wearer of a robe of eyes gains a +10 competence bonus on Perception checks. She retains her Dexterity bonus to AC even when flat-footed, and can't be flanked. She is not able to avert or close her eyes when confronted by a creature with a gaze attack. A light or continual flame spell cast directly on a robe of eyes causes it to be blinded for 1d3 minutes. A daylight spell blinds it for 2d4 minutes.",
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  {
    id: 'rod-of-metal-and-mineral-detection',
  ...
  {
    id: 'rod-of-thunder-and-lightning',
  ...
  },
  {
    ...
    description:
      'Usually carved from the heartwood of an ancient oak or other large tree, this staff allows use of the following spells: Dispel magic (1 charge) Resist energy (1 charge) Shield (1 charge) Dismissal (2 charges) Lesser globe of invulnerability (2 charges) Repulsion (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  },
  {
    ...
    description:
      'This staff is usually made of ash or walnut and bears ornate carvings of many different kinds of creatures. It allows use of the following spells: Stinking cloud (1 charge) Summon swarm (1 charge) Unseen servant (1 charge) Cloudkill (2 charges) Minor creation (2 charges) Summon monster VI (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'The staff of defense is a simple-looking polished wooden staff that throbs with power when held defensively. It allows use of the following spells: Shield (1 charge) Shield of Faith (1 charge) Shield other (1 charge) Shield of law (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  },
  {
    ...
    description:
      'This staff is topped with a fist-sized emerald that gleams with smoldering power. It allows the use of the following spells: Move earth (1 charge) Passwall (1 charge)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'Often made from applewood and topped with a clear crystal, this staff allows use of the following spells: Hideous laughter (1 charge) Sleep (1 charge) Suggestion (1 charge) Crushing despair (2 charges) Mind fog (2 charges) Mass suggestion (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'This smooth hickory or yew staff allows use of the following spells: Fireball (1 charge) Magic missile (1 charge) Shatter (1 charge) Ice storm (2 charges) Wall of force (2 charges) Chain lightning (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'Crafted from bronzewood with brass bindings, this staff allows use of the following spells: Burning hands (1 charge) Fireball (2 charges) Wall of fire (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'Tipped on either end with a glistening diamond, this rune-covered staff allows use of the following spells: Ice storm (1 charge) Wall of ice (2 charges) Cone of cold (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'This white ash staff is decorated with inlaid silver runes. It allows use of the following spells: Cure serious wounds (1 charge) Lesser restoration (1 charge) Remove blindness/deafness (2 charges) Remove disease (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'This staff is usually sheathed in silver and decorated with sunbursts. It allows use of the following spells: Dancing lights (1 charge) Flare (1 charge) Daylight (2 charges) Sunburst (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'This staff is made from ebony or other dark wood and carved into an intricately twisted, fluted, or spiral shape. It allows use of the following spells: Disguise self (1 charge) Major image (1 charge) Mirror image (1 charge) Persistent image (2 charges) Rainbow pattern (2 charges) Mislead (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'A staff of life is made of thick polished oak shod in gold and decorated with sinuous runes. This staff allows use of the following spells: Heal (1 charge) Raise dead (5 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'This staff is made from ebony or other dark wood and carved with images of bones and skulls mingled with strange spidery runes. It allows use of the following spells: Cause fear (1 charge) Ghoul touch (1 charge) Halt undead (1 charge) Enervation (2 charges) Waves of fatigue (2 charges) Circle of death (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'This potent item allows use of the following spells: Dimension door (1 charge) Passwall (1 charge) Greater teleport (2 charges) Phase door (2 charges) Astral projection (2 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'The staff of power is a very potent magic item with offensive and defensive abilities. It is usually topped with a glistening gem that often burns from within with a flickering red light. The staff allows the use of the following spells: Continual flame (1 charge) Fireball (heightened to 5th level) (1 charge) Levitate (1 charge) Lightning bolt (heightened to 5th level) (1 charge) Magic missile (1 charge) Ray of enfeeblement (heightened to 5th level) (1 charge) Cone of cold (2 charges) Globe of invulnerability (2 charges) Hold monster (2 charges) Wall of force (in a 10-ft.-diameter hemisphere around the caster only) (2 charges) The wielder of a staff of power gains a +2 luck bonus to AC and on saving throws. The staff is also a +2 quarterstaff, and its wielder may use it to smite opponents. If 1 charge is expended (as a free action), the staff causes double damage (×3 on a critical hit) for 1 round. A staff of power can be used for a retributive strike, requiring it to be broken by its wielder. (If this breaking of the staff is purposeful and declared by the wielder, it can be performed as a standard action that does not require the wielder to make a Strength check.) All charges currently in the staff are instantly released in a 30-foot spread. All within 2 squares of the broken staff take points of damage equal to 20 × the number of charges in the staff, those 3 or 4 squares away take 15 × the number of charges in damage, and those 5 or 6 squares distant take 10 × the number of charges in damage. All those affected can make DC 17 Reflex saves to reduce the damage by half. The character breaking the staff has a 50% chance of traveling to another plane of existence, but if he does not, the explosive release of spell energy destroys him. Only certain items, including the staff of the magi and the staff of power, are capable of being used for a retributive strike.',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    ...
    description:
      'This staff of dark wood is relatively more stout and sturdy than most magical staves, with a gnarled and twisted knot of wood at the top end. It allows use of the following spells: Enlarge person (1 charge) Reduce person (1 charge) Shrink item (2 charges) Mass enlarge person (3 charges) Mass reduce person (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  },
  {
    ...
    description:
      'This staff is generally carved from or decorated with petrified wood or fossilized bone, each etched with tiny but complex runes. It allows use of the following spells: Alter self (1 charge) Blink (1 charge) Expeditious retreat (1 charge) Baleful polymorph (2 charges) Polymorph (2 charges) Disintegrate (3 charges)',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  ...
  },
  {
    ...
    description:
      'An evil divine spellcaster who possesses this item can cause a flaming crack to open at the feet of a good divine spellcaster who is up to 100 feet away. The intended victim is swallowed up forever and sent hurtling to the center of the earth. The wielder of the talisman must be evil, and if she is not exceptionally foul and perverse in the sights of her evil deity, the good character gains a DC 19 Reflex save to leap away from the crack. Obviously, the target must be standing on solid ground for this item to function. A talisman of ultimate evil has 6 charges. If a neutral (LN, N, CN) divine spellcaster touches one of these stones, she takes 6d6 points of damage per round of contact. If a good divine spellcaster touches one, she takes 8d6 points of damage per round of contact. All other characters are unaffected by the device. If a talisman of ultimate evil is given to the newborn child of a redeemed villain, it instantly crumbles to dust.',
    requiresAttunement: false,
    modifiers: [],
    effects: [],
  },
  {
    id: 'the-orbs-of-dragonkind',
