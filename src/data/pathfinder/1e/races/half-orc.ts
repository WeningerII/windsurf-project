...
export const halfOrc: Species = {
  ...
  languages: {
    ...
    choice: {
      count: 0,
      options: ['Abyssal', 'Draconic', 'Giant', 'Gnoll', 'Goblin'],
  ...
  traits: [
    ...
    },
    {
      ...
      name: 'Intimidating',
      source: 'Half-Orc',
      description: 'Half-orcs receive a +2 racial bonus on Intimidate checks.',
    },
    {
      id: 'orc-blood',
      name: 'Orc Blood',
  ...
  description:
    "Half-orcs are monstrosities, their tragic births the result of perversion and violence—or at least, that's how other races see them.",
