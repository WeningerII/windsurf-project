...
export const elf: Species = {
  ...
  abilityScoreIncrease: [{ type: 'fixed', attributes: { dex: 2, int: 2, con: -2 } }],
  ...
  languages: {
    ...
    choice: {
      count: 0,
      options: ['Celestial', 'Draconic', 'Gnoll', 'Gnome', 'Goblin', 'Orc', 'Sylvan'],
  ...
  traits: [
    ...
    },
    {
      ...
      source: 'Elf',
      description:
        'Elves are proficient with longbows, longswords, rapiers, and shortbows, and treat any weapon with the word "elven" in its name as a martial weapon.',
    },
  ],
