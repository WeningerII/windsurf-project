...
export const dwarf: Species = {
  ...
  abilityScoreIncrease: [{ type: 'fixed', attributes: { con: 2, wis: 2, cha: -2 } }],
  ...
  traits: [
    ...
    },
    {
      ...
      source: 'Dwarf',
      description:
        'Dwarves gain a +4 racial bonus to their CMD when resisting a bull rush or trip attempt while standing on the ground.',
    },
    {
      id: 'stonecunning',
      name: 'Stonecunning',
  ...
  description:
    'Dwarves are a stoic but stern race, ensconced in cities carved from the hearts of mountains and fiercely determined to repel the depredations of savage races.',
  ageInfo:
    'Dwarves are considered young until age 40, reach adulthood around 40, and can live over 400 years.',
