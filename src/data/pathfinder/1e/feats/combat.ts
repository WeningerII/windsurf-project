...
export const cleave: FeatDefinition = {
  ...
  prerequisites: [
    ...
    { type: 'other', description: 'Power Attack, base attack bonus +1' },
  ],
...
export const deadlyAim: FeatDefinition = {
  ...
  prerequisites: [
    ...
    { type: 'other', description: 'Base attack bonus +1' },
  ],
...
export const doubleSlice: FeatDefinition = {
  ...
  prerequisites: [
    ...
    { type: 'other', description: 'Two-Weapon Fighting' },
  ],
...
export const greatCleave: FeatDefinition = {
  ...
  prerequisites: [
    { type: 'ability', ability: 'str', value: 13 },
    { type: 'other', description: 'Cleave, Power Attack, base attack bonus +4' },
  ],
...
export const stunningFist: FeatDefinition = {
  ...
  prerequisites: [
    ...
    { type: 'other', description: 'Improved Unarmed Strike, base attack bonus +8' },
  ],
...
export const weaponSpecialization: FeatDefinition = {
  ...
  source: 'CRB',
  prerequisites: [
    { type: 'other', description: 'Weapon Focus with selected weapon, fighter level 4' },
  ],
...
export const greaterTwoWeaponFighting: FeatDefinition = {
  ...
  prerequisites: [
    ...
    { type: 'other', description: 'Improved Two-Weapon Fighting, base attack bonus +11' },
  ],
...
export const manyshot: FeatDefinition = {
  ...
  prerequisites: [
    { type: 'ability', ability: 'dex', value: 15 },
    { type: 'other', description: 'Point-Blank Shot, Rapid Shot, base attack bonus +6' },
  ],
