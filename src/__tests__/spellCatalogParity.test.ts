...
const PF1E_SOURCE_ROWS_WITHOUT_SAVING_THROW = [
  ...
  'pf1e-elemental-body-i',
  'pf1e-elemental-body-ii',
  'pf1e-elemental-body-iii',
  'pf1e-elemental-body-iv',
  ...
  'pf1e-major-creation',
  'pf1e-make-whole',
  'pf1e-mass-charm-monster',
  'pf1e-mass-hold-monster',
  'pf1e-maze',
  'pf1e-meld-into-stone',
  'pf1e-mirror-image',
  'pf1e-misdirection',
  'pf1e-mnemonic-enhancer',
