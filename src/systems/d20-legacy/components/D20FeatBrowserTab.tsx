...
type D20FeatBrowserTabComponent = React.FC<Props> & {
  preload: () => Promise<unknown>;
};

export const D20FeatBrowserTab = (({ systemId, featsLoaded, featDefs }: Props) =>
  !featsLoaded ? (
  ...
  )) as D20FeatBrowserTabComponent;

D20FeatBrowserTab.preload = () => FeatBrowser.preload();
