...
function toSpellBrowserSpell(spell: Spell): SpellBrowserSpell {
  return {
    ...
    scaling: spell.heightening?.summary ?? spell.atHigherLevels,
  };
}

type Pf2eSpellBrowserPanelComponent = React.FC<Props> & {
  preload: () => Promise<unknown>;
};

export const Pf2eSpellBrowserPanel = (({ spells, onSelectSpell }) => (
  <Suspense
    fallback={
...
)) as Pf2eSpellBrowserPanelComponent;

Pf2eSpellBrowserPanel.preload = () => SpellBrowser.preload();
