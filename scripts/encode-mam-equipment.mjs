 ...
 * of that data set. Entries with NO SRD counterpart were not deleted — they are
 * segregated into ./original-not-srd.ts under an honest non-SRD source label
 * (see docs/mam3e-equipment-provenance.md for the item-by-item record).
 *
