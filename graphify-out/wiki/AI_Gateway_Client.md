...
- **AiRequest** (2 connections) — `src/ai/contracts.ts`
- **jsonResponse()** (1 connections) — `src/__tests__/ai/gatewayClient.test.ts`
- **payload** (1 connections) — `src/__tests__/ai/gatewayClient.test.ts`

## Relationships

- [AI Gateway Contracts](AI_Gateway_Contracts.md) (6 shared connections)
- [AI Gateway Adapters](AI_Gateway_Adapters.md) (5 shared connections)
- [AI Encounter Draft Flow](AI_Encounter_Draft_Flow.md) (4 shared connections)
...
- `src/__tests__/ai/gatewayClient.test.ts`
- `src/ai/contracts.ts`
- `src/ai/gatewayClient.ts`
