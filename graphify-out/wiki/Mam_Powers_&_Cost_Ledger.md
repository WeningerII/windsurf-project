...
- **buildMam3ePowerCostLedgerEntries()** (9 connections) — `src/systems/mam3e/contributionLedger.ts`
- **getPowerModifierRank()** (9 connections) — `src/systems/mam3e/powerMath.ts`
- **.prepareData()** (7 connections) — `src/systems/mam3e/engine.ts`
- **MamPowersTab()** (5 connections) — `src/systems/mam3e/components/MamPowersTab.tsx`
- **calculateMam3eFinalPowerCost()** (5 connections) — `src/systems/mam3e/powerMath.ts`
...
- `src/__tests__/mam3eContributionLedger.test.ts`
