...
- **SceneMarkerKind** (4 connections) — `src/types/core/scene.ts`
...
- **MarkerPanelProps** (3 connections) — `src/components/scene/MarkerPanel.tsx`
- **OraclePanel()** (3 connections) — `src/components/scene/OraclePanel.tsx`
- **OraclePanelProps** (3 connections) — `src/components/scene/OraclePanel.tsx`
- **isTerrainOperation()** (3 connections) — `src/rules/terrain/sceneTerrain.ts`
...
- `src/__tests__/components/OraclePanel.test.tsx`
- `src/__tests__/rules/sceneTerrain.test.ts`
- `src/__tests__/scene/check.test.ts`
- `src/components/scene/CheckPanel.tsx`
- `src/components/scene/MarkerPanel.tsx`
- `src/components/scene/OraclePanel.tsx`
- `src/rules/terrain/sceneTerrain.ts`
- `src/scene/check.ts`
- `src/scene/oracle.ts`
