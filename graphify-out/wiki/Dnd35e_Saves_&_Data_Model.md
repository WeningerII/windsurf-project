...
- **SYSTEM_SUPPORT_NOTES** (5 connections) — `src/utils/documentationCopy.ts`
...
- `src/__tests__/d20-legacy-manual-extras.test.tsx`
...
- `src/__tests__/engines/dnd35e-engine.test.ts`
- `src/__tests__/engines/pf1e-engine.test.ts`
- `src/__tests__/rules/engineAttackIntegration.test.ts`
...
- `src/systems/d20-legacy/wrapper.ts`
