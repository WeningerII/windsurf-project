...
- **contracts.ts** (64 connections) — `src/ai/contracts.ts`
- **isRecord()** (11 connections) — `src/ai/contracts.ts`
- **parseTaskData()** (8 connections) — `src/ai/contracts.ts`
- **contracts.test.ts** (8 connections) — `src/__tests__/ai/contracts.test.ts`
- **parseAiRequest()** (7 connections) — `src/ai/contracts.ts`
- **parseTaskPayload()** (6 connections) — `src/ai/contracts.ts`
- **isAiResponse()** (5 connections) — `src/ai/contracts.ts`
- **parseIdentifyCreaturePayload()** (5 connections) — `src/ai/contracts.ts`
- **isAiTask()** (4 connections) — `src/ai/contracts.ts`
- **parseAiImageInput()** (4 connections) — `src/ai/contracts.ts`
- **parseCandidateList()** (4 connections) — `src/ai/contracts.ts`
- **parseEncounterDraftPayload()** (4 connections) — `src/ai/contracts.ts`
- **parseEncounterDraftData()** (3 connections) — `src/ai/contracts.ts`
- **parseGeneratedImageData()** (3 connections) — `src/ai/contracts.ts`
- **parseIdentifyCreatureData()** (3 connections) — `src/ai/contracts.ts`
...
- `src/__tests__/ai/contracts.test.ts`
- `src/ai/contracts.ts`
