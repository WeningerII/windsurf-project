...
- **encode-pf2e-monsters.mjs** (14 connections) — `scripts/encode-pf2e-monsters.mjs`
- **main()** (8 connections) — `scripts/encode-pf2e-monsters.mjs`
...
- **SIZES** (1 connections) — `scripts/encode-pf2e-monsters.mjs`
- **TYPE_MAP** (1 connections) — `scripts/encode-pf2e-monsters.mjs`
