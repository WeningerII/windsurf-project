...
- **spellModules** (1 connections) — `src/__tests__/spell-validation.test.ts`
- **VALID_SCHOOLS** (1 connections) — `src/__tests__/spell-validation.test.ts`
...
- `src/__tests__/spell-validation.test.ts`
