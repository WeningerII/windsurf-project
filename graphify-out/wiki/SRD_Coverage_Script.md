...
- **fetchSrd35SpellNames()** (2 connections) — `src/scripts/srd-coverage.ts`
- **fetchSrd52MonsterNames()** (2 connections) — `src/scripts/srd-coverage.ts`
- **fetchSrd52SpellNames()** (2 connections) — `src/scripts/srd-coverage.ts`
- **cats5e2014** (1 connections) — `src/scripts/srd-coverage.ts`
- **cats5e2024** (1 connections) — `src/scripts/srd-coverage.ts`
- **CoverageTarget** (1 connections) — `src/scripts/srd-coverage.ts`
- **fetchNames()** (1 connections) — `src/scripts/srd-coverage.ts`
- **loaderNames()** (1 connections) — `src/scripts/srd-coverage.ts`
- **NamedEntry** (1 connections) — `src/scripts/srd-coverage.ts`
- **Row** (1 connections) — `src/scripts/srd-coverage.ts`
- **SRD35_MONSTER_FILES** (1 connections) — `src/scripts/srd-coverage.ts`
