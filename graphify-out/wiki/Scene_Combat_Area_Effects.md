...
- **gridDistance()** (8 connections) — `src/rules/resolver/areaTargeting.ts`
- **resolveDaggerheartAttack()** (7 connections) — `src/rules/resolver/daggerheartResolution.ts`
- **resolveMam3eAttack()** (7 connections) — `src/rules/resolver/mam3eResolution.ts`
...
- [Character Effects Compilation](Character_Effects_Compilation.md) (76 shared connections)
- [Condition Effects by System](Condition_Effects_by_System.md) (47 shared connections)
...
- [Dnd5e2024 Engine & Hit Dice](Dnd5e2024_Engine_%26_Hit_Dice.md) (6 shared connections)
...
- `src/rules/resolver/areaTargeting.ts`
- `src/rules/resolver/attackResolution.ts`
- `src/rules/resolver/daggerheartResolution.ts`
- `src/rules/resolver/mam3eResolution.ts`
- `src/rules/resolver/participantResolution.ts`
- `src/rules/resolver/resolve.ts`
- `src/rules/resolver/sceneCombat.ts`
