...
- **removeSyncTombstones()** (9 connections) — `src/utils/syncTombstones.ts`
- **clearQueuedDeletedCampaignIds()** (8 connections) — `src/utils/syncEngine.ts`
- **useEntitySync()** (7 connections) — `src/hooks/useEntitySync.ts`
- **syncTombstones.test.ts** (7 connections) — `src/__tests__/utils/syncTombstones.test.ts`
...
- [Campaign Storage & Hooks](Campaign_Storage_%26_Hooks.md) (1 shared connections)
- [Boundary Validation Tests](Boundary_Validation_Tests.md) (1 shared connections)
- [System Registry & Renderer](System_Registry_%26_Renderer.md) (1 shared connections)

## Source Files

- `src/__tests__/hooks/useCampaignSync.test.tsx`
- `src/__tests__/utils/syncEngineCampaigns.test.ts`
- `src/__tests__/utils/syncTombstones.test.ts`
- `src/contexts/auth-context.ts`
- `src/hooks/useCampaignSync.ts`
