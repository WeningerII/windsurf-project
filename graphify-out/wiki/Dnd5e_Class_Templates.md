...
- **useDnd5eTemplateHandlers()** (9 connections) — `src/systems/dnd5e/shared/useDnd5eTemplateHandlers.ts`
- **seedHitDieRolls()** (8 connections) — `src/utils/templateShared.ts`
- **hitDieFaces()** (7 connections) — `src/utils/templateShared.ts`
- **Dnd5eClassesSection()** (6 connections) — `src/systems/dnd5e/shared/components/Dnd5eClassesSection.tsx`
- **averageHitDieRoll()** (3 connections) — `src/utils/templateShared.ts`
- **canSelectSubclass()** (2 connections) — `src/systems/dnd5e/shared/components/Dnd5eClassesSection.tsx`

## Relationships

- [Dnd5e Equipment & Features UI](Dnd5e_Equipment_%26_Features_UI.md) (10 shared connections)
- [Class Enhancement & Headers](Class_Enhancement_%26_Headers.md) (7 shared connections)
