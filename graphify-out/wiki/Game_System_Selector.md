...
- **system-catalog.ts** (14 connections) — `src/types/system-catalog.ts`
- **systemCatalog.test.ts** (13 connections) — `src/__tests__/utils/systemCatalog.test.ts`
- **SystemCatalogSummary** (9 connections) — `src/types/system-catalog.ts`
- **loadSystemCatalogSummaryFromMetadata()** (9 connections) — `src/utils/systemCatalogMetadata.ts`
- **loadSystemCatalogSummary()** (8 connections) — `src/utils/systemCatalog.ts`
- **loadAllSystemCatalogSummariesFromMetadata()** (7 connections) — `src/utils/systemCatalogMetadata.ts`
...
- **GameSystemSelector()** (4 connections) — `src/components/GameSystemSelector.tsx`
...
- `src/components/shared/supportBadges.ts`
- `src/types/system-catalog.ts`
- `src/utils/systemCatalog.ts`
- `src/utils/systemCatalogMetadata.ts`
- `src/utils/systemCatalogShared.ts`
