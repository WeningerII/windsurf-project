...
- [capabilityScenarios.test.tsx](capabilityScenarios.test.tsx.md) (11 shared connections)
- [App Shell & Layout](App_Shell_%26_Layout.md) (10 shared connections)
- [Quest & Session Log UI](Quest_%26_Session_Log_UI.md) (10 shared connections)
...
- `src/App.tsx`
- `src/__tests__/components/CombatPanel.test.tsx`
- `src/__tests__/components/ConfirmDialog.test.tsx`
- `src/__tests__/components/RecapPanel.test.tsx`
- `src/__tests__/components/SceneGridView.test.tsx`
- `src/__tests__/hooks/useServiceWorkerUpdate.test.tsx`
- `src/__tests__/scene/sceneRecap.test.ts`
- `src/__tests__/utils/fileTransfer.test.ts`
...
- `src/components/scene/CombatPanel.tsx`
- `src/components/scene/RecapPanel.tsx`
