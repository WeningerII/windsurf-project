...
- **DO_WRITE** (1 connections) — `scripts/check-compute-register.mjs`
- **FLAGS** (1 connections) — `scripts/check-compute-register.mjs`
- **GATE_JSON** (1 connections) — `scripts/check-compute-register.mjs`
- **REGISTER_FILE_BY_SYSTEM** (1 connections) — `scripts/check-compute-register.mjs`
- **REPO_ROOT** (1 connections) — `scripts/check-compute-register.mjs`
- **SCRATCH** (1 connections) — `scripts/check-compute-register.mjs`
- **SCRIPT_DIR** (1 connections) — `scripts/check-compute-register.mjs`
- **vitestCache** (1 connections) — `scripts/check-compute-register.mjs`
...
- `docs/compute-register/mutation-anchors.ts`
- `scripts/check-compute-register.mjs`
