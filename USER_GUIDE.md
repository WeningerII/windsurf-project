...
- **D&D 5th Edition (2024)** - SRD 5.2 content (315 spells, 91 feats, 147 equipment items)
- **D&D 5th Edition (2014)** - SRD 5.1 content (238 spells, 213 equipment items)
- **D&D 3.5 Edition** - SRD 3.5 content (555 spells, 184 feats)
- **Pathfinder 1e** - Core complete (134 spells, 176 feats, 11 classes)
- **Pathfinder 2e** - Core complete (146 spells, 133 feats, 12 classes)
- **Mutants & Masterminds 3e** - SRD content (111 powers, 108 advantages)
...
3. Click "Create New Character" to open the guided creation wizard

### Wizard Navigation
- Use **Next** and **Previous** to move between steps
- Use **Cancel** to return to the home screen without saving

### Step 2: Basic Information
Fill in the following fields:
- **Character Name** - Your character's name (required)
- **Level** - Character level (1-20)
- **Species/Race** - Your character's species
- **Class** - Your character's class(es)
...
4. Click "← Back" button to return to character list
...
Use the **Data Management** card on the home screen to:
...
For full legal information, see `SRD_COMPLIANCE.md`.
