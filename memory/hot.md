...
**Last updated:** 2026-08-02. Branch `claude/master-plan-unfinished-s1lsya`.
...
- **`wip/lane-snapshot`** still needs deleting from the GitHub UI; the sandbox
  git proxy refuses remote branch deletion.
